...
function __cpc__scriptsAction() {
	...
	if (!is_admin()) {
		...
		wp_localize_script( '__cpc__', '__cpc__', array(
			...
			'request_sent' 		=> sprintf(__("Deine %s-Anfrage wurde gesendet.", 'cp-communitie'), get_option(CPC_OPTIONS_PREFIX.'_alt_friend')),
			'add_a_comment' 	=> __( 'Einen Kommentar hinzufügen:', 'cp-communitie'),
			'add' 				=> __( 'Hinzufügen', 'cp-communitie'),
			'show_original' 	=> __( 'Original anzeigen', 'cp-communitie'),
			'write_a_comment' 	=> __( 'Schreibe einen Kommentar...', 'cp-communitie'),
			'follow_box' 		=> __( 'Hi', 'cp-communitie'),
			'events_enable_places' => __( 'Buchung von Plätzen ermöglichen:', 'cp-communitie'),
			'events_max_places' => __( 'Maximale Plätze:', 'cp-communitie'),
			'events_show_max'	 => __( 'Maximale Plätze:', 'cp-communitie'),
			'events_confirmation' => __( 'Buchungen müssen bestätigt werden:', 'cp-communitie'),
			'events_tickets_per_booking' => __( 'Maximale Anzahl von Tickets pro Buchung:', 'cp-communitie'),
			'events_tab_1' 		=> __( 'Zusammenfassung', 'cp-communitie'),
			'events_tab_2' 		=> __( 'Mehr Informationen', 'cp-communitie'),
			'events_tab_3' 		=> __( 'E-Mail-Bestätigung', 'cp-communitie'),
			'events_tab_4' 		=> __( 'Teilnehmer', 'cp-communitie'),
			'events_send_email' => __( 'Bestätigungsmail senden:', 'cp-communitie'),
			'events_replacements' => __( 'Du kannst die folgenden Möglichkeiten nutzen:', 'cp-communitie'),
			'events_pay_link' 	=> __( 'HTML für die Bezahlung:', 'cp-communitie'),
			'events_cost' 		=> __( 'Preis pro Buchung:', 'cp-communitie'),
			'events_howmany' 	=> __( 'Wie viele Tickets möchtest Du?', 'cp-communitie'),
			'events_labels' 	=> __( 'Ref|Benutzer|Gebucht|E-Mail-Bestätigung gesendet|# Tickets|Bestätigte Zahlung|Aktionen|Teilnehmer bestätigen|Mail senden|Bestätigungs-E-Mail erneut senden|Teilnehmer entfernen|Bestätige die Zahlung', 'cp-communitie'),
			'gallery_labels' 	=> __( 'Umbenennen|Bild umbenannt.|Ziehe die Miniaturbilder, um sie neu anzuordnen, und dann|speichern|Dieses Bild löschen|Als Album-Cover eingestellt', 'cp-communitie'),
			'sending' 			=> __( 'Senden', 'cp-communitie'),
			'go' 				=> __( 'Los', 'cp-communitie'),
			'bbcode_url'	 	=> __( 'Gib eine Webseiten-URL ein...', 'cp-communitie'),
			'bbcode_problem' 	=> __( 'Bitte stelle sicher, dass alle BB Codes offene und geschlossene Tags haben!', 'cp-communitie'),
			'bbcode_label' 		=> __( 'Text eingeben, um anzuzeigen...', 'cp-communitie')			
		));
