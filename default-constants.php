...
if ( !defined('CPC_DIR') ) 						define('CPC_DIR', 'cp-communitie'); 										// Installed plugin folder (within WordPress plugins)
...
if ( !defined('CPC_HIDE_DASHBOARAD_W') )		define('CPC_HIDE_DASHBOARAD_W', false);									// Whether to hide CPC WordPress admin dashboard widget
...
if ( !defined('CPC_CHANGE_AUTHORURI') )			define('CPC_CHANGE_AUTHORURI', 'http://www.cpcymposium.com');			// Author web address, or false to skip
if ( !defined('CPC_CHANGE_PLUGINURI') )			define('CPC_CHANGE_PLUGINURI', 'http://www.cpcymposium.com');			// Plugin web address, or false to skip
...
if ( !defined('CPC_OPTIONS_PREFIX') )		define('CPC_OPTIONS_PREFIX', 'cpcommunitie'); 								// Prefix for WordPress options table (make this unique!!)
