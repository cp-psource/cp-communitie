...
<?php
	...
	<tr valign="top"> 
	<td scope="row"><label for="show_resized"><?php _e('Re-size photos in slideshow', CPC_TEXT_DOMAIN); ?></label></td>
	<td>
	<input type="checkbox" name="show_resized" id="show_resized" <?php if ($show_resized == "on") { echo "CHECKED"; } ?>/>
	<span class="description"><?php echo __('Re-sizing photos will ensure that are displayed at nice size and speed up loading, but will stretch small images', CPC_TEXT_DOMAIN); ?></span></td> 
	</tr> 

	<tr valign="top"> 
	<td scope="row"><label for="thumbnail_size"><?php _e('Thumbnail size', CPC_TEXT_DOMAIN); ?></label></td> 
	<td><input name="thumbnail_size" type="text" id="thumbnail_size" style="width:50px" value="<?php echo $thumbnail_size; ?>" /> 
	<span class="description"><?php echo __('Size of gallery thumbnails', CPC_TEXT_DOMAIN); ?></td> 
	</tr> 
	
	<tr valign="top"> 
	<td scope="row"><label for="gallery_page_length"><?php _e('Page size', CPC_TEXT_DOMAIN); ?></label></td> 
	<td><input name="gallery_page_length" type="text" id="gallery_page_length" style="width:50px" value="<?php echo $gallery_page_length; ?>" /> 
	<span class="description"><?php echo __('Number of albums to show on the gallery page (shortcode)', CPC_TEXT_DOMAIN); ?></td> 
	</tr> 
	
	<tr valign="top"> 
	<td scope="row"><label for="gallery_preview"><?php _e('Preview photos', CPC_TEXT_DOMAIN); ?></label></td> 
	<td><input name="gallery_preview" type="text" id="gallery_preview" style="width:50px" value="<?php echo $gallery_preview; ?>" /> 
	<span class="description"><?php echo __('Number of photos to show on one row as an album preview on the gallery page (shortcode)', CPC_TEXT_DOMAIN); ?></td> 
	</tr> 
	...
	<table style="margin-left:10px; margin-top:10px;">						
		...
		<tr><td width="165px">[<?php echo CPC_SHORTCODE_PREFIX; ?>-galleries]</td>
			<td><?php echo __('Displays a gallery of all the user albums.', CPC_TEXT_DOMAIN); ?></td></tr>
	</table>
	<?php 	
