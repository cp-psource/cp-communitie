jQuery(document).ready(function() { 
	...
	if (jQuery('#__cpc__current_user_page').length) {
		__cpc__.current_user_page = jQuery('#__cpc__current_user_page').html();
	}
...
/*
	...
	*/
	...
	if (__cpc__.current_user_id > 0) {
		jQuery('#basic_file_upload').on('click', function() {
	...
	var cpcommunitie_clear = __cpc__.clear;
	var cpcommunitie_update = __cpc__.update;
	var cpcommunitie_cancel = __cpc__.cancel;
	var write_a_comment = __cpc__.write_a_comment;
	var btn_add = __cpc__.add;
	var show_original = __cpc__.show_original;
	var add_a_comment = __cpc__.add_a_comment;
	var pleasewait = __cpc__.pleasewait;
	var saving = __cpc__.saving;
	var more = __cpc__.more;
	var browseforfile = __cpc__.browseforfile;
	var attachfile = __cpc__.attachfile;
	var attachimage = __cpc__.attachimage;
	var whatsup = __cpc__.whatsup;
	var cpcommunitie_next = __cpc__.next;
	var cpcommunitie_likes = __cpc__.likes;
	var cpcommunitie_dislikes = __cpc__.dislikes;
	var areyousure = __cpc__.areyousure;
...
/*
	...
	*/
	...
	if (jQuery("#cpcommunitie_summary_Widget").length) {
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/widget_functions.php",
			data: ({
				action: "cpcommunitie_summary_Widget",
				show_loggedout: jQuery("#cpcommunitie_summary_Widget_show_loggedout").html(),
				form: jQuery("#cpcommunitie_summary_Widget_form").html(),
				login_url: jQuery("#cpcommunitie_summary_Widget_login_url").html(),
				show_avatar: jQuery("#cpcommunitie_summary_Widget_show_avatar").html(),
				show_avatar_size: jQuery("#cpcommunitie_summary_Widget_show_avatar_size").html(),
				login_username: jQuery("#cpcommunitie_summary_Widget_login_username").html(),
				login_password: jQuery("#cpcommunitie_summary_Widget_login_password").html(),
				login_remember_me: jQuery("#cpcommunitie_summary_Widget_login_remember_me").html(),
				login_button: jQuery("#cpcommunitie_summary_Widget_login_button").html(),
				login_forgot: jQuery("#cpcommunitie_summary_Widget_login_forgot").html(),
				login_register: jQuery("#cpcommunitie_summary_Widget_login_register").html(),
			}),
			type: "POST",
			dataType: "html",
			async: true,
			success: function(str) {
				if (str.substring(0, 4) == 'FAIL') {
					jQuery("#dialog").html(str).dialog({
						title: __cpc__.site_title + ' debug',
						width: 800,
						height: 500,
						modal: true
					});
				} else {
					jQuery("#cpcommunitie_summary_Widget").html(str);
				}
			}
		});
	}

	if (jQuery("#cpcommunitie_friends_Widget").length) {
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/widget_functions.php",
			data: ({
				action: "cpcommunitie_friends_Widget",
				count: jQuery("#cpcommunitie_friends_count").html(),
				desc: jQuery("#cpcommunitie_friends_desc").html(),
				mode: jQuery("#cpcommunitie_friends_mode").html(),
				show_light: jQuery("#cpcommunitie_friends_show_light").html(),
				show_mail: jQuery("#cpcommunitie_friends_show_mail").html()
			}),
			type: "POST",
			dataType: "html",
			async: true,
			success: function(str) {
				if (str.substring(0, 4) == 'FAIL') {
					...
					jQuery("#cpcommunitie_friends_Widget").html(str);
				}
			}
		});
	}

	if (jQuery("#__cpc__Forumexperts_Widget").length) {
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/widget_functions.php",
			data: ({
				action: "Forumexperts_Widget",
				cat_id: jQuery("#__cpc__Forumexperts_Widget_cat_id").html(),
				cat_id_exclude: jQuery("#__cpc__Forumexperts_Widget_cat_id_exclude").html(),
				timescale: jQuery("#__cpc__Forumexperts_Widget_timescale").html(),
				postcount: jQuery("#__cpc__Forumexperts_Widget_postcount").html(),
				groups: jQuery("#__cpc__Forumexperts_Widget_groups").html()
			}),
			type: "POST",
			dataType: "html",
			async: true,
			success: function(str) {
				if (str.substring(0, 4) == 'FAIL') {
					...
					jQuery("#__cpc__Forumexperts_Widget").html(str);
				}
			}
		});
	}

	if (jQuery("#__cpc__Forumnoanswer_Widget").length) {
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/widget_functions.php",
			data: ({
				action: "Forumnoanswer_Widget",
				preview: jQuery("#__cpc__Forumnoanswer_Widget_preview").html(),
				cat_id: jQuery("#__cpc__Forumnoanswer_Widget_cat_id").html(),
				cat_id_exclude: jQuery("#__cpc__Forumnoanswer_Widget_cat_id_exclude").html(),
				timescale: jQuery("#__cpc__Forumnoanswer_Widget_timescale").html(),
				postcount: jQuery("#__cpc__Forumnoanswer_Widget_postcount").html(),
				groups: jQuery("#__cpc__Forumnoanswer_Widget_groups").html()
			}),
			type: "POST",
			dataType: "html",
			async: true,
			success: function(str) {
				if (str.substring(0, 4) == 'FAIL') {
					...
					jQuery("#__cpc__Forumnoanswer_Widget").html(str);
				}
			}
		});
	}

	if (jQuery("#__cpc__recent_Widget").length) {
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/widget_functions.php",
			data: ({
				action: "recent_Widget",
				count: jQuery("#__cpc__recent_Widget_count").html(),
				desc: jQuery("#__cpc__recent_Widget_desc").html(),
				show_light: jQuery("#__cpc__recent_Widget_show_light").html(),
				show_mail: jQuery("#__cpc__recent_Widget_show_mail").html()
			}),
			type: "POST",
			dataType: "html",
			async: true,
			success: function(str) {
				if (str.substring(0, 4) == 'FAIL') {
					...
					jQuery("#__cpc__recent_Widget").html(str);
				}
			}
		});
	}

	if (jQuery("#cpcommunitie_members_Widget").length) {
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/widget_functions.php",
			data: ({
				action: "members_Widget",
				count: jQuery("#cpcommunitie_members_Widget_count").html()
			}),
			type: "POST",
			dataType: "html",
			async: true,
			success: function(str) {
				if (str.substring(0, 4) == 'FAIL') {
					...
					jQuery("#cpcommunitie_members_Widget").html(str);
				}
			}
		});
	}

	if (jQuery("#__cpc__friends_status_Widget").length) {
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/widget_functions.php",
			data: ({
				action: "friends_status_Widget",
				postcount: jQuery("#__cpc__friends_status_postcount").html(),
				preview: jQuery("#__cpc__friends_status_preview").html(),
				forum: jQuery("#__cpc__friends_status_forum").html()
			}),
			type: "POST",
			dataType: "html",
			async: true,
			success: function(str) {
				if (str.substring(0, 4) == 'FAIL') {
					...
					jQuery("#__cpc__friends_status_Widget").html(str);
				}
			}
		});
	}

	if (jQuery("#cpcommunitie_Recentactivity_Widget").length) {
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/widget_functions.php",
			data: ({
				action: "Recentactivity_Widget",
				postcount: jQuery("#cpcommunitie_Recentactivity_Widget_postcount").html(),
				preview: jQuery("#cpcommunitie_Recentactivity_Widget_preview").html(),
				forum: jQuery("#cpcommunitie_Recentactivity_Widget_forum").html()
			}),
			type: "POST",
			dataType: "html",
			async: true,
			success: function(str) {
				if (str.substring(0, 4) == 'FAIL') {
					...
					jQuery("#cpcommunitie_Recentactivity_Widget").html(str);
				}
			}
		});
	}

	if (jQuery("#__cpc__Forumrecentposts_Widget").length) {
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/widget_functions.php",
			data: ({
				action: "__cpc__Forumrecentposts_Widget",
				postcount: jQuery("#__cpc__Forumrecentposts_Widget_postcount").html(),
				preview: jQuery("#__cpc__Forumrecentposts_Widget_preview").html(),
				cat_id: jQuery("#__cpc__Forumrecentposts_Widget_cat_id").html(),
				show_replies: jQuery("#__cpc__Forumrecentposts_Widget_show_replies").html(),
				incl_cat: jQuery("#__cpc__Forumrecentposts_Widget_incl_cat").html(),
				incl_parent: jQuery("#__cpc__Forumrecentposts_Widget_incl_parent").html(),
				just_own: jQuery("#__cpc__Forumrecentposts_Widget_just_own").html()
			}),
			type: "POST",
			dataType: "html",
			async: true,
			success: function(str) {
				if (str.substring(0, 4) == 'FAIL') {
					...
					jQuery("#__cpc__Forumrecentposts_Widget").html(str);
				}
			}
		});
	}

	if (jQuery("#cpcommunitie_Gallery_Widget").length) {
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/gallery_functions.php",
			data: ({
				action: "Gallery_Widget",
				albumcount: jQuery("#cpcommunitie_Gallery_Widget_albumcount").html()
			}),
			type: "POST",
			dataType: "html",
			async: true,
			success: function(str) {
				if (str.substring(0, 4) == 'FAIL') {
					...
					jQuery("#cpcommunitie_Gallery_Widget").html(str);
				}
			}
		});
	}
	...
	if (jQuery("#__cpc__Alerts_Widget").length) {
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/widget_functions.php",
			data: ({
				action: "Alerts_Widget",
				postcount: jQuery("#__cpc__Alerts_Widget_postcount").html()
			}),
			type: "POST",
			dataType: "html",
			async: true,
			success: function(str) {
				if (str.substring(0, 4) == 'FAIL') {
					...
					jQuery("#__cpc__Alerts_Widget").html(str);
				}
			}
		});
	}		
	...
	*/
	...
	jQuery('#cpcommunitie_member').live("keydown", function(e) {
		...
		if (keyCode == 9 || keyCode == 27) {
			jQuery('#cpcommunitie_member_list').hide();
		}

	});

	// Order by
	jQuery('#cpcommunitie_members_orderby').change(function() {
	...
	function cpcommunitie_do_member_search(clear) {
		
		if (__cpc__.dir_full_ver) {
			jQuery('#cpcommunitie_members_orderby_div').hide();
		}

		if (clear) {
			jQuery('#__cpc__members').html("<img src='" + __cpc__.images_url + "/busy.gif' />");
		} else {
			jQuery('#showmore_directory_div').html("<br /><img src='" + __cpc__.images_url + "/busy.gif' />");
		}

		// check for extended fields
		if (jQuery(".cpcommunitie_extended_search").length && jQuery("#cpcommunitie_advanced_search").css("display") != 'none') {
			var extended = new Array();
			jQuery(".cpcommunitie_extended_search").each(function(index) {
		...
		var page_length = jQuery('#cpcommunitie_directory_page_length').html();
		var start = jQuery("#cpcommunitie_directory_start").html();

		var friends = '';
		if (jQuery("#cpcommunitie_member_friends").is(":checked")) {
			var friends = 'on';
		};

		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/members_functions.php",
			type: "POST",
			data: ({
				action: "getMembers",
				friends: friends,
				start: start,
				orderby: jQuery('#cpcommunitie_members_orderby').val(),
				page_length: jQuery('#cpcommunitie_directory_page_length').html(),
				term: jQuery('#cpcommunitie_member').val(),
				extended: extended,
				roles: jQuery('#__cpc__directory_roles').html()
			}),
			dataType: "html",
			async: true,
			success: function(str) {
				...
				if (clear) {
					jQuery("#__cpc__members").html('');
				}
				jQuery('#showmore_directory_div').remove();
				var new_start = parseFloat(start) + parseFloat(page_length) + 1;
				jQuery("#cpcommunitie_directory_start").html(new_start);

				if (start == 0) {
					jQuery('#__cpc__members').html(str);
				} else {
					jQuery(str).appendTo('#__cpc__members').hide().slideDown("slow");
				}
	...
	// Autocomplete
	if (jQuery("input#cpcommunitie_member").length) {

		jQuery("input#cpcommunitie_member").autocomplete({
			...
			focus: function(event, ui) {
				jQuery("input#cpcommunitie_member").val(ui.item.name);
				return false;
			},
			select: function(event, ui) {
				jQuery(".__cpc__pleasewait").inmiddle().show().delay(3000).fadeOut("slow");
				var q = cpcommunitie_q(__cpc__.profile_url);
				window.location.href = __cpc__.profile_url + q + 'uid=' + ui.item.value;
				return false;
			}
...
/*
	...
	*/
	...
	jQuery("#cpcommunitie_compose_tab").live("click", function() {
		...
		jQuery('#cpcommunitie_compose_tab').addClass("nav-tab-active");
		jQuery('#cpcommunitie_compose_tab a').addClass("nav-tab-active-link");

		jQuery('#cpcommunitie_inbox_tab').removeClass("nav-tab-active");
		jQuery('#cpcommunitie_inbox_tab a').removeClass("nav-tab-active-link");
		jQuery('#cpcommunitie_inbox_tab').addClass("nav-tab-inactive");
		jQuery('#cpcommunitie_inbox_tab a').addClass("nav-tab-inactive-link");

		jQuery('#cpcommunitie_sent_tab').removeClass("nav-tab-active");
		jQuery('#cpcommunitie_sent_tab a').removeClass("nav-tab-active-link");
		jQuery('#cpcommunitie_sent_tab').addClass("nav-tab-inactive");
		jQuery('#cpcommunitie_sent_tab a').addClass("nav-tab-inactive-link");
	...
	jQuery("#cpcommunitie_inbox_tab").live("click", function() {
		...
		jQuery('#cpcommunitie_compose_tab').addClass("nav-tab-inactive");
		jQuery('#cpcommunitie_compose_tab a').addClass("nav-tab-inactive-link");

		jQuery('#cpcommunitie_inbox_tab').removeClass("nav-tab-inactive");
		jQuery('#cpcommunitie_inbox_tab a').removeClass("nav-tab-inactive-link");
		jQuery('#cpcommunitie_inbox_tab').addClass("nav-tab-active");
		jQuery('#cpcommunitie_inbox_tab a').addClass("nav-tab-active-link");
	...
	jQuery("#cpcommunitie_sent_tab").live("click", function() {
		...
		jQuery('#cpcommunitie_sent_tab').removeClass("nav-tab-inactive");
		jQuery('#cpcommunitie_sent_tab a').removeClass("nav-tab-inactive-link");
		jQuery('#cpcommunitie_sent_tab').addClass("nav-tab-active");
		jQuery('#cpcommunitie_sent_tab a').addClass("nav-tab-active-link");
	...
	if (__cpc__.view == 'compose') {

		jQuery(".__cpc__pleasewait").inmiddle().show();

		var mail_to = __cpc__.to;
		...
		jQuery(".__cpc__pleasewait").fadeOut("slow");
	...
	// Default load	
	if (jQuery("#compose_form").length && __cpc__.view != 'compose') {

		// Load box on first page load
		jQuery('#mailbox_list').html("<img src='" + __cpc__.images_url + "/busy.gif' />");
		jQuery('#messagebox').html("<img src='" + __cpc__.images_url + "/busy.gif' />");

		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/mail_functions.php",
			type: "POST",
			data: ({
				uid: __cpc__.current_user_page,
				action: "getBox",
				tray: "in",
			...
			success: function(str) {
				...
				if (strpos(str, 'mail_mid')) {
					...
					var template = __cpc__.template_mail_tray;
	...
	jQuery('#__cpc__mail_bulk_action').change(function() {
		var action = jQuery('#__cpc__mail_bulk_action').val();
		// bulk: delete all
		if (action == 'deleteall') {
			if (confirm(areyousure)) {
				...
				jQuery.ajax({
					...
					data: ({
						...
						data: '',
						tray: tray,
						uid: __cpc__.current_user_id,
						scope: 'all'
					}),
					dataType: "html",
					async: false,
					success: function(str) {
						if (str != 'OK') jQuery("#dialog").html(str).dialog({ title: __cpc__.site_title+' debug info', width: 800, height: 500, modal: true });
					}
				});
				change_tray();
				jQuery(".__cpc__pleasewait").fadeOut("slow");
	...
	jQuery("#show_more_mail").live("click", function() {
		...
		jQuery('#show_more_mail').html("<img src='" + __cpc__.images_url + "/busy.gif' />");
	...
	jQuery("#mail_send_button").live("click", function() {
		...
		jQuery("#compose_form").hide();
		jQuery('#mail_sent_message').show().html("<img src='" + __cpc__.images_url + "/busy.gif' />");
	...
	function cpcommunitie_do_mail_search() {
	...
	function change_tray() {
		...
		if (tray == 'in') {
			jQuery("#__cpc__mark_all").attr('disabled', false);
		} else {
			jQuery("#__cpc__mark_all").attr('disabled', true);
		}
...
/*
	...
	*/
	...
	if ((jQuery("#profile_body").length) && (__cpc__.embed != 'on')) {

		var menu_id = 'menu_' + __cpc__.view;

		if (menu_id == 'menu_in') {
			menu_id = 'menu_friends';
		}

		if (jQuery('#force_profile_page').length && __cpc__.view == 'in') {
		...
		if ((menu_id == 'menu_extended') || (menu_id == 'menu_wall') || (menu_id == 'menu_activity') || (menu_id == 'menu_all') || (menu_id == 'menu_mentions') || (menu_id == 'menu_groups') || (menu_id == 'menu_friends') || (menu_id == 'menu_avatar') || (menu_id == 'menu_personal') || (menu_id == 'menu_settings')) {
			...
			var ajax_path = __cpc__.plugin_url + "ajax/profile_functions.php";			
			...
			if (strpos(ajax_part, '->') !== false) {
				...
				var ajax_path = __cpc__.plugin_url + "ajax/" + ajax_sub + "_functions.php";
				menu_id = menu_id.replace(/->/g, "_");
			} else {
				ajax_part = ajax_part.replace(/_me/g, "");
				var ajax_path = __cpc__.plugin_url + "ajax/" + ajax_part + "_functions.php";
			}

		} else if (menu_id == 'menu_news') {

			var ajax_path = __cpc__.plugin_url + "ajax/news_functions.php";			

		} else if (jQuery('#force_profile_page').length) {
			
			// force the page content
			var ajax_path = __cpc__.plugins+'/cp-communitie-'+jQuery('#force_profile_page').html()+'/ajax/cp-communitie-'+jQuery('#force_profile_page').html()+'_functions.php';
			menu_id = 'cp-communitie-'+jQuery('#force_profile_page').html();
			
		} else {
			// passed in URL
			var ajax_path = __cpc__.plugins+'/cp-communitie-'+__cpc__.view+'/ajax/cp-communitie-'+__cpc__.view+'_functions.php';
			menu_id = 'cp-communitie-'+__cpc__.view;
		}
		

		if (menu_id == 'menu_') {
			menu_id = 'menu_wall';
			ajax_path = __cpc__.plugin_url + "ajax/profile_functions.php";
		}
		...
		jQuery('#' + menu_id).addClass('__cpc__profile_current');
		...
		jQuery.ajax({
			...
			data: ({
				...
				post: __cpc__.post,
				limit_from: 0,
				uid1: __cpc__.current_user_page,
				rel: rel
			}),
			dataType: "html",
			async: true,
			success: function(str) {
				...
				var user_id = jQuery("#cpcommunitie_user_id").html();
				var user_login = jQuery("#cpcommunitie_user_login").html();
				var user_email = jQuery("#cpcommunitie_user_email").html();
				...
				if (jQuery('.__cpc__reply').length) {
					var w = jQuery('.__cpc__reply').css('width').replace(/px/g, "");
					jQuery('.__cpc__reply').css('width', (w-30)+'px');
				}
				if (jQuery('#__cpc__comment').length) {
					var p = jQuery('#cpcommunitie_add_status').css('width').replace(/px/g, "");
					jQuery('#__cpc__comment').css('width', (p-5)+'px');
				}
	...
	if (jQuery('#__cpc__comment').length) {
		var p = jQuery('#__cpc__comment').parent().css('width').replace(/px/g, "");
		jQuery('#__cpc__comment').css('width', (p-5)+'px');
	}
	...
	jQuery('.cpcommunitie_wall_replies').live("mouseenter mouseleave", function(event) {
		if (event.type == 'mouseenter') {
			...
			jQuery("#__cpc__reply_div_" + jQuery(this).attr("id")).slideUp("fast");
		}
	});
	...
	jQuery(".poke-button").live("click", function() {
		...
		jQuery.ajax({
			...
			data: ({
				action: 'send_poke',
				recipient: __cpc__.current_user_page
			}),
			dataType: "html",
			async: false,
			success: function(str) {}
		...
		jQuery.ajax({
			...
			success: function(str) {
				...
				if (jQuery("#profile_body").length) {
					...
					jQuery(str).appendTo('.__cpc__wrapper').hide().slideDown("slow");
				}
			}
		});
	...
	jQuery(".__cpc__profile_menu").on('click', function() {
		...
		if (jQuery(".__cpc__top_menu").length) {
			jQuery('.__cpc__top_menu').removeClass('__cpc__dropdown_tab_on').addClass('__cpc__dropdown_tab_off');
			jQuery(this).closest('.__cpc__top_menu').removeClass('__cpc__dropdown_tab_off').addClass('__cpc__dropdown_tab_on');
			
			jQuery(this).parent().hide();
		}

		jQuery('.__cpc__profile_menu').removeClass('__cpc__profile_current');
		jQuery(this).addClass('__cpc__profile_current');

		var menu_id = jQuery(this).attr("id");
		var menu_slug = jQuery(this).attr("name");		
		jQuery('#profile_body').html("<img src='" + __cpc__.images_url + "/busy.gif' />");

		if (!(jQuery("#profile_body").length)) {
			var view = menu_id.replace(/menu_/g, "");
			var q = cpcommunitie_q(__cpc__.profile_url);
			window.location.href = __cpc__.profile_url + q + 'view=' + view;
		}
		...
		if ((menu_id == 'menu_extended') || (menu_id == 'menu_wall') || (menu_id == 'menu_activity') || (menu_id == 'menu_all') || (menu_id == 'menu_mentions') || (menu_id == 'menu_groups') || (menu_id == 'menu_friends') || (menu_id == 'menu_avatar') || (menu_id == 'menu_personal') || (menu_id == 'menu_settings')) {
			...
			// added on menu item (ie. ID = cp-communitie-example)
			var ajax_path = __cpc__.plugins+'/'+menu_id+'/ajax/'+menu_id+'_functions.php';
		...
		jQuery.ajax({
			...
			data: ({
				...
				menu_slug:menu_slug,
				uid1: __cpc__.current_user_page,
				display_name: __cpc__.current_user_display_name
			}),
			dataType: "html",
			async: true,
			success: function(str) {
		...
		jQuery.ajax({
			...
			success: function(str) {
				if (str.length <= 1 || trim(str) == '' || trim(str) == '0') {
					...
					jQuery(".__cpc__notice").fadeOut("slow");
					alert('Oops: ' + str);
				}
			},
			error: function(xhr, ajaxOptions, thrownError) {
	...
	function cpcommunitie_add_comment_to_profile() {
		
		var comment_text = jQuery("#__cpc__comment").val().replace(/(<([^>]+)>)/ig, '');
		...
		if (comment_text != '' || code != '' || img != '') {
			...
			jQuery('#cpcommunitie_add_status').hide();
			setTimeout(function() {
				if (jQuery('#btn-span-tmp').html() != '') {
					jQuery('#btn-span').html(jQuery('#btn-span-tmp').html());
				}
				jQuery('#fileupload-info').html('');
				jQuery('#__cpc__comment').css('height', '50px');
				jQuery('#cpcommunitie_add_status').slideDown('fast');
			}, 3000);

			var comment = "<div class='add_wall_post_div' style='"
			if (__cpc__.row_border_size != '') {
				comment = comment + " border-top:" + __cpc__.row_border_size + "px " + __cpc__.row_border_style + " " + __cpc__.text_color_2 + ";";
			}
			comment = comment + "'>";
			comment = comment + "<div class='add_wall_post'>";
			comment = comment + "<div class='add_wall_post_text'>";
			var q = cpcommunitie_q(__cpc__.profile_url);
			comment = comment + '<a href="' + __cpc__.profile_url + q + 'uid=' + __cpc__.current_user_id + '">';
			comment = comment + __cpc__.current_user_display_name + '</a><br />';
			comment = comment + comment_text;

			// Check for uploaded image
			if (jQuery('#__cpc__file_upload_iframe').length) {
				var bfu = jQuery("#__cpc__file_upload_iframe").contents().find('#forum_file_list').html();
				if (typeof bfu != 'undefined') {
					comment = comment + "<div id='myimage'><img id='cpcommunitie_tmp' src='" + __cpc__.images_url + "/busy.gif' /></div>";
					jQuery('#__cpc__file_upload_iframe').remove();
				}
			}
			if (jQuery("#activity_file_upload_file").length) {
				if (jQuery("#activity_file_upload_file").html() != '') {
			...
			comment = comment + "<img src='" + jQuery('#__cpc__current_user_avatar img:first').attr('src') + "' style='width:64px; height:64px' />";
			comment = comment + "</div>";

			jQuery("#__cpc__comment").val('');
			jQuery(comment).insertAfter('#cpcommunitie_add_status').hide().slideDown('fast');


			var facebook_post = 0;
			if (jQuery("#post_to_facebook").length) {
				if (jQuery("#post_to_facebook").is(":checked")) {
					if (__cpc__.current_user_page == __cpc__.current_user_id) {
						facebook_post = 1;
					}
				}
			}
			...
			jQuery.ajax({
				...
				data: ({
					action: "addStatus",
					subject_uid: __cpc__.current_user_page,
					parent: 0,
					text: comment_text,
				...
				success: function(str) {
					...
					if (str) {
						jQuery('#myimage:first').html('<a target="_blank" href="'+str+'" rev="1" rel="cpcommunitie_tmp_activity_image" data-owner="'+__cpc__.current_user_id+'" data-name="" data-iid="1" class="cpc_gallery_album"><img class="profile_activity_image" src="' + str + '" /></a>');
					}
					jQuery('#activity_youtube_embed_button_used').attr('id', 'activity_youtube_embed_button');
	...
	jQuery(".cpcommunitie_add_reply").live("click", function() {
		...
		var t = this;
		setTimeout(function() {
			jQuery('.__cpc__reply').css('height', '44px');
	...
	function cpcommunitie_add_comment(comment_trigger) {

		var comment_id = jQuery(comment_trigger).attr("title");
		var author_id = jQuery('#cpcommunitie_author_' + comment_id).val();
		var comment_text = jQuery("#__cpc__reply_" + comment_id).val().replace(/(<([^>]+)>)/ig, '');
		...
		if (comment_text != '' && comment_text != '\n' && comment_text != write_a_comment && comment_text != write_a_comment + '\n') {
			...
			comment = comment + "<div class='__cpc__wall_reply_div'";
			if (__cpc__.bg_color_2 != '') {
				comment = comment + " style='background-color:" + __cpc__.bg_color_2 + "'";
			}
			comment = comment + ">";
			...
			comment = comment + "<img src='" + jQuery('#__cpc__current_user_avatar img:first').attr('src') + "' style='width:40px; height:40px' />";
			comment = comment + "</div>";
			comment = comment + "</div>";

			jQuery(comment).appendTo('#__cpc__comment_' + comment_id);
			jQuery("#__cpc__reply_" + comment_id).val('');
	...
	jQuery("#updateSettingsButton").live("click", function() {
		...
		var profile_label = jQuery("#__cpc__profile_label").val().replace(/(<([^>]+)>)/ig, '');
	...
	function addasfriend(id, msg) {
		...
		jQuery.ajax({
			...
			async: true,
			success: function(str) {
				jQuery("#dialog").html(__cpc__.request_sent);
				jQuery("#dialog").dialog({
					title: __cpc__.site_title,
					width: 600,
					height: 225,
...
/*
	...
	*/
    ...
    jQuery("ul.__cpc__dropdown li").hover(function(){
	...
	if (__cpc__.profile_menu_scrolls == 'on') {
		...
		if (el.length) {
			...
			var d = parseInt(__cpc__.profile_menu_delta);
			el.css('position', 'absolute');
			el.css('top', '0px');
			jQuery('.__cpc__wrapper').addClass('__cpc__wrapper-min-height');
	...
	jQuery(".wall_add_like").live("click", function() {
		...
		// Store choice
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/plus_functions.php",
			type: "POST",
			data: ({
				action: "likeDislike",
				choice: choice,
	...
	jQuery("#cpcommunitie_show_likes").live("click", function() {
		...
		str += '<div id="__cpc__who_dislikes" style="width:49%;float:right;"><strong>' + cpcommunitie_dislikes + '</strong><br /><br />' + busy + '</div>';
		str += '<div id="__cpc__who_likes" style="width:49%;"><strong>' + cpcommunitie_likes + '</strong><br /><br />' + busy + '</div>';
		jQuery("#dialog").html(str).dialog({
			title: __cpc__.site_title,
			width: 600,
			height: 300,
		...
		jQuery.ajax({
			...
			success: function(str) {
				if (str != 'None') {
					...
					likes = '<strong>' + cpcommunitie_likes + '</strong><br /><br />' + likes;
					jQuery('#__cpc__who_likes').html(likes);
				} else {
					jQuery('#__cpc__who_likes').html('<strong>' + cpcommunitie_likes + '</strong>');
				}
			}
		});
		jQuery.ajax({
			...
			success: function(str) {
				if (str != 'None') {
					...
					dislikes = '<strong>' + cpcommunitie_dislikes + '</strong><br /><br />' + dislikes;
					jQuery('#__cpc__who_dislikes').html(dislikes);
				} else {
					jQuery('#__cpc__who_dislikes').html('<strong>' + cpcommunitie_dislikes + '</strong>');
				}
			}
		});
	})
	...
	// Combined search
	if (jQuery("input#__cpc__member_small").length) {

		jQuery("input#__cpc__member_small").autocomplete({
			source: __cpc__.plugin_url + "ajax/plus_functions.php",
			minLength: 1,
			focus: function(event, ui) {
				jQuery("input#__cpc__member_small").val(ui.item.name);
				return false;
			},
			select: function(event, ui) {
				jQuery(".__cpc__pleasewait").inmiddle().show().delay(3000).fadeOut("slow");
				switch (ui.item.type) {
				case 'topic':
					var q = cpcommunitie_q(__cpc__.forum_url);
					window.location.href = __cpc__.forum_url + q + 'show=' + ui.item.id;
					break;
				case 'post':
				...
				case 'amember':
					...
					break;
				case 'group':
					var q = cpcommunitie_q(__cpc__.group_url);
					window.location.href = __cpc__.group_url + q + 'gid=' + ui.item.value;
					break;
				case 'gallery':
					var q = cpcommunitie_q(__cpc__.profile_url);
					window.location.href = __cpc__.profile_url + q + 'uid=' + ui.item.owner + '&embed=on&album_id=' + ui.item.id;
					break;
				}
				return false;
			}
			...
			if (item.type == 'sep') {
				...
				return jQuery('<li class="__cpc__autocomplete_sep"></li>').append(item.name).appendTo(ul);
				...
				group += "</div>";
				group += "</a>";
				return jQuery('<li class="__cpc__autocomplete_item"></li>').data("item.autocomplete", item).append(group).appendTo(ul);
	...
	jQuery('.__cpc__follow').live("mouseenter mouseleave", function(event) {
		if (event.type == 'mouseenter' && __cpc__.current_user_id > 0) {
			...
			if (id != jQuery('#nobody_user').html()) {
				...
				var xPos = event.pageX - (jQuery('#__cpc__follow_box').width() / 2);
				var yPos = event.pageY - (jQuery('#__cpc__follow_box').height() / 2);
				var html = '<img id="cpcommunitie_plus_box_avatar" src="' + src + '" style="width:20px;height:20px;float:right;" />';
				var q = cpcommunitie_q(__cpc__.profile_url);
				
				html += '<a style="font-size:14px;" href="' + __cpc__.profile_url + q + 'uid=' + id + '">' + display_name + '</a><br />';
				if (rel == 'friend' || id == __cpc__.current_user_id) {
					if (strpos(__cpc__.mail_url, 'INVALID PLUGIN URL REQUESTED') === false && id != __cpc__.current_user_id) {
						html += '<input id="cpcommunitie_plus_sendmail" ref="' + id + '" type="text" class="__cpc__hover_input" onblur = "this.value=(this.value==\'\') ? \'' + __cpc__.sendmail + '\' : this.value;"  onfocus= "this.value=(this.value==\'' + __cpc__.sendmail + '\') ? \'\' : this.value;"  value  = "' + __cpc__.sendmail + '" />';
					} else {
						html += '<input id="cpcommunitie_plus_post" type="text" class="__cpc__hover_input"  onfocus= "this.value= \'\'"  value  = "' + __cpc__.whatsup + '" />';
					}
				} else {
					if (rel == 'pending') {
						var q = cpcommunitie_q(__cpc__.profile_url);
						html += '<div style="margin-top:4px;margin-bottom:8px;"><a href="' + __cpc__.profile_url + q + 'view=friends">' + __cpc__.friendpending + '</a></div>';
					} else {
						html += '<input id="cpcommunitie_plus_addasafriend" title="' + id + '" type="text" class="__cpc__hover_input"  onblur = "this.value=(this.value==\'\') ? \'' + __cpc__.addasafriend + '...\' : this.value;"  onfocus= "this.value=(this.value==\'' + __cpc__.addasafriend + '...\') ? \'\' : this.value;"  value  = "' + __cpc__.addasafriend + '..." />';
					}
				}
				html += "<div class='__cpc__hover_box_icons' style='clear:both'>";
					html += "<img id='cpcommunitie_plus_profile' ref='" + id + "' title='" + __cpc__.profile_info + "' style='float:left; margin-right:5px; cursor:pointer' src='" + __cpc__.images_url + "/profile.png' />";
					html += "<img id='cpcommunitie_plus_friends' ref='" + id + "' title='" + __cpc__.plus_friends + "' style='float:left; margin-right:5px; cursor:pointer' src='" + __cpc__.images_url + "/friends.png' />";
					if (id == __cpc__.current_user_id) {
						html += "<img id='cpcommunitie_following_who' title='" + __cpc__.plus_follow_who + "' style='float:left; margin-right:5px; cursor:pointer' src='" + __cpc__.images_url + "/fav-who.png' />";
						html += "<img id='cpcommunitie_plus_mail' title='" + __cpc__.plus_mail + "' style='float:left; margin-right:5px; cursor:pointer' src='" + __cpc__.images_url + "/mail.png' />";
					} else {
						if (rev == 'following') {
							html += "<img id='cpcommunitie_following' title='" + __cpc__.unfollow + "' ref='" + id + "' style='float:left; margin-right:5px; cursor:pointer' src='" + __cpc__.images_url + "/fav-on.png' />";
						} else {
							html += "<img id='cpcommunitie_following' title='" + __cpc__.follow + "' ref='" + id + "' style='float:left; margin-right:5px; cursor:pointer' src='" + __cpc__.images_url + "/fav-off.png' />";
						}
						if (__cpc__.cpc_use_poke) {
							html += "<img id='__cpc__attention' title='" + __cpc__.attention + "' ref='" + id + "' style='float:left; margin-right:5px; cursor:pointer' src='" + __cpc__.images_url + "/attention.png' />";
						}
					}
					if (strpos(__cpc__.forum_url, 'INVALID PLUGIN URL REQUESTED') === false) {
						html += "<img id='cpcommunitie_forum_search' title='" + __cpc__.forumsearch + "' rel='" + display_name + "' ref='" + id + "' style='float:left; margin-right:5px; cursor:pointer' src='" + __cpc__.images_url + "/search2.png' />";
					}
					if (__cpc__.gallery_url != '') {
						html += '<img style="cursor:pointer" rel="' + display_name + '" id="cpcommunitie_gallery_search" src="' + __cpc__.images_url + '/gallery.png" title="' + __cpc__.gallerysearch + '" /></a>';
					}
				html += "</div>";

				jQuery('#__cpc__follow_box').html(html);
	...
	jQuery('#cpcommunitie_plus_box_avatar').live("mouseenter mouseleave", function(event) {
		if (event.type == 'mouseenter') {
			...
			jQuery('#cpcommunitie_plus_box_avatar').css({
				'width': '184px',
				'height': '184px'
			});
		}
	...
	jQuery('#cpcommunitie_plus_post').live("keypress", function(e) {
		if (e.keyCode == 13) {
			...
			if (message != '' && message != jQuery('#cpcommunitie_whatsup').html()) {

				// Add to wall if on page
				if (jQuery("#__cpc__wall").css("display") != 'none' && __cpc__.current_user_page == __cpc__.current_user_id) {
					...
					comment = comment + "</div>";
					comment = comment + "</div>";
					jQuery(comment).prependTo('#__cpc__wall');
				}
				...
				jQuery.ajax({
					...
					async: true,
					success: function(str) {
						jQuery(".__cpc__pleasewait").hide();
						jQuery('.__cpc__follow_box').hide();

						if (__cpc__.current_user_page != __cpc__.current_user_id || jQuery("#__cpc__wall").length == 0) {
							jQuery("#dialog").html(__cpc__.whatsup_done + '<br /><br />' + message);
							jQuery("#dialog").dialog({
								title: __cpc__.site_title,
								width: 300,
								height: 250,
								...
								buttons: {
									...
									"View": function() {
										jQuery(".__cpc__pleasewait").inmiddle().show();
										window.location = __cpc__.profile_url;
									}
								}
							});
						}
	...
	jQuery(".follow-button").live("click", function() {
		...
		jQuery.ajax({
			...
			data: ({
				...
				following: __cpc__.current_user_page
			}),
			dataType: "html",
			async: true,
			success: function(str) {
	...
	jQuery("#cpcommunitie_following").live("click", function() {
		...
		if (jQuery(this).attr("src") == __cpc__.images_url + '/fav-on.png') {
			...
			jQuery(this).attr("src", __cpc__.images_url + '/fav-off.png');
			jQuery.ajax({
				url: __cpc__.plugin_url + "ajax/plus_functions.php",
				type: "POST",
				data: ({
			...
			// Add to following
			jQuery(this).attr("src", __cpc__.images_url + '/fav-on.png');
			jQuery.ajax({
				url: __cpc__.plugin_url + "ajax/plus_functions.php",
				type: "POST",
				data: ({
		...
		if (e.keyCode == 13) {
			...
			jQuery.ajax({
				...
				data: ({
					action: "sendMail",
					compose_recipient_id: recipient_id,
					compose_subject: __cpc__.privatemail,
				...
				async: true,
				success: function(str) {
					jQuery(".__cpc__sending").hide();
					jQuery('.__cpc__follow_box').hide();
					var avatar = "<img style='float:left; width:48px; height:48px;margin-right:10px;' src='" + jQuery('#cpcommunitie_plus_box_avatar').attr("src") + "' />";
					jQuery("#dialog").html(avatar + message);
					jQuery("#dialog").dialog({
						title: __cpc__.privatemailsent,
						width: 300,
						height: 250,
						modal: true,
						buttons: {
...
/*
	...
	*/
	...
	if (__cpc__.forum_ajax == 'on') {

		jQuery(window).bind('hashchange', function(e) {

			var tmp_loc = window.location.href.replace(/\//g, '').toLowerCase();
			var tmp_url = __cpc__.forum_url.replace(/\//g, '').toLowerCase();
	...
	if (jQuery("#__cpc__forum_div").length) {

		// Make sure reply field is empty
		jQuery('#__cpc__reply_text').val('');
		if (jQuery("#__cpc__forum_div").html() == '') {

			var sub = "getForum";
			if (__cpc__.show_tid > 0) {
				var sub = "getTopic";
			}
			...
			if (hash != '') {
				...
				for (var num = 0; num < pieces.length; num++) {
					var piece = pieces[num].split('=');
					if (piece[0] == 'cid') {
						__cpc__.cat_id = piece[1];
						goto_cid = true;
					}
					if (piece[0] == 'tid') {
						goto_tid = true;
						__cpc__.show_tid = piece[1];
					}
			...
			if (jQuery("#cpcommunitie_perma_topic_id").length) {
				__cpc__.show_tid = jQuery("#cpcommunitie_perma_topic_id").html();
				if (jQuery("#cpcommunitie_perma_cat_id").length) {
					__cpc__.cat_id = jQuery("#cpcommunitie_perma_cat_id").html();
				}
				if (__cpc__.show_tid != '') {
					sub = "getTopic";
				} else {
			...
			jQuery.ajax({
				...
				data: ({
					action: sub,
					limit_from: 0,
					cat_id: __cpc__.cat_id,
					topic_id: __cpc__.show_tid,
					group_id: __cpc__.current_group
				}),
				dataType: "html",
				async: true,
				success: function(str) {
					...
					if (str != 'DONTSHOW') {
						...
						if (strpos(str, "[|]", 0)) {
							...
							if (__cpc__.cpc_wysiwyg == 'skipping_this_as_caused_layout_problems_on') {
						...
						jQuery("#__cpc__forum_div").html(str);

						// Enable file uploading
						__cpc__init_file_upload();

						// Init TinyMCE
						if (__cpc__.cpc_wysiwyg == 'on') {
							if (sub == 'getForum') {
								...
								if (typeof tinyMCE.get("__cpc__reply_text") != 'undefined') tinyMCE.get('__cpc__reply_text').setContent('');
							}
						}
			...
			var str = jQuery("#__cpc__forum_div").html();
		...
		// Enable file uploading
		if (__cpc__.show_tid == 0) {
			jQuery("#cpcommunitie_perma_topic_id").html() != '' ? __cpc__.show_tid = jQuery("#cpcommunitie_perma_topic_id").html() : 0;
		} // If not using AJAX
		if (!__cpc__.show_tid && __cpc__.show_tid != 0) __cpc__.show_tid = 0;
	...
	jQuery(".quick-comment-box-add").live("click", function() {
		...
		var a = jQuery('#__cpc__current_user_avatar').html();
		if (a && a.length > 0) {
			a = a.replace(/200/g, '32');
			a = a.replace(/196/g, '32');
			html += a;
		} else {
			// Problem retrieving user avatar - is there a wp_footer action to run __cpc__lastactivity() ?
		}
		...
		jQuery.ajax({
			...
			data: ({
				action: "replycomment",
				'tid': jQuery('#__cpc__reply_tid').val(),
				'cid': jQuery('#__cpc__reply_cid').val(),
				'rid': rid,
			...
			success: function(str) {
				...
				jQuery.ajax({
					...
					success: function(str) {
						if (__cpc__.debug) {
							jQuery("#dialog").html(str).dialog({
								title: __cpc__.site_title + ' debug info (send replies)',
								width: 800,
								height: 500,
								modal: true
							});
	...
	jQuery(".forum_post_answer").live("click", function() {
		...
		jQuery(this).text("");
		jQuery("<img id='cpcommunitie_tmp' src='" + __cpc__.images_url + "/busy.gif' />").prependTo(this);
		...
		jQuery('#cpcommunitie_accepted_answer').hide();
		jQuery("#cpcommunitie_tmp").hide();
		jQuery(this).show();
		jQuery("<img id='cpcommunitie_tmp' src='" + __cpc__.images_url + "/tick.png' />").prependTo(this);
	...
	jQuery(".remove_forum_post").live("click", function() {
		...
		var me = this;
		jQuery(this).attr('src', __cpc__.images_url + "/busy.gif");
	...
	jQuery("#showmore_forum").live("click", function() {
		...
		jQuery('#showmore_forum').html("<img src='" + __cpc__.images_url + "/busy.gif' />");
		...
		jQuery.ajax({
			...
			success: function(str) {
				...
				jQuery(str).appendTo('#__cpc__table').hide().slideDown("slow");
			}
		});
	...
	jQuery("#fav_link").live("click", function() {
		...
		if (jQuery('#fav_link').attr('src') == __cpc__.images_url + '/fav-on.png') {
			jQuery('#fav_link').attr({
				src: __cpc__.images_url + '/fav-off.png'
			});
		} else {
			jQuery('#fav_link').attr({
				src: __cpc__.images_url + '/fav-on.png'
			});
		}
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/forum_functions.php",
	...
	jQuery(".__cpc__delete_fav").live("click", function() {
		...
		jQuery(".__cpc__notice").delay(100).fadeOut("slow");
	...
	jQuery('.fav_row').live("mouseenter mouseleave", function(event) {
		if (event.type == 'mouseenter') {
			...
			jQuery(this).find(".__cpc__delete_fav").hide();
		}
	});
	...
	function do_show_search() {
		...
		search_form += "<input type='submit' class='__cpc__button' style='margin-top:2px; margin-left:10px;' id='search-box-button' value='"+__cpc__.go+"' />";
		search_form += "</div>";
	...
	function do_forum_search() {
		jQuery("#search-internal").html("<img src='" + __cpc__.images_url + "/busy.gif' />");
	...
	jQuery('#starting-post').live("mouseenter mouseleave", function(event) {
		if (event.type == 'mouseenter') {
			...
			jQuery(this).find(".cpcommunitie_report").hide();
			...
			buttons: {
				"Update": function() {
					...
					jQuery.ajax({
						...
						async: true,
						success: function(str) {
							jQuery(".__cpc__notice").fadeOut("fast");
						},
						error: function(xhr, ajaxOptions, thrownError) {
							if (show_js_errors) {
								alert(xhr.status);
		...
		jQuery("#dialog").dialog({
			...
			buttons: {
				"Update": function() {
					...
					var bbcodes_ok = __cpc__bbcodes_ok(topic_post);
					if (!bbcodes_ok) {
						alert(__cpc__.bbcode_problem);
					} else {
	...
	jQuery("#quick-reply-warning").live("click", function() {
		...
		if (!__cpc__.use_wp_editor) {
			...
			var reply_text = jQuery('#__cpc__reply_text').val().replace(/[\n\r]$/, "");

			if (__cpc__.cpc_wysiwyg == 'on') {
				var reply_text = tinyMCE.get('__cpc__reply_text').getContent();
			}
		...
		if (reply_text == '') {
			if (__cpc__.cpc_wysiwyg != 'on') {
				jQuery("#__cpc__reply_text").css('border', '1px solid red').effect("highlight", {}, 4000);
			}
		} else {

			// Check for unclosed BB Codes
			var bbcodes_ok = __cpc__bbcodes_ok(reply_text);
			if (!bbcodes_ok) {
				alert(__cpc__.bbcode_problem);
			} else {
				...
				if (__cpc__.cpc_forum_refresh != 'on') {
					...
					if (__cpc__.cpc_wysiwyg != 'on') {
						...
						if (!__cpc__.use_wp_editor) {
							tinyMCE.get('__cpc__reply_text').setContent('');
						} else {
					...
					success: function(str) {
						...
						jQuery.ajax({
							...
							success: function(str) {
								...
								if (__cpc__.cpc_forum_refresh == 'on' && __cpc__.debug != 'on') {
									location.reload();
								}
	...
	jQuery("#new-topic-button").live("click", function() {
		...
		jQuery(".__cpc__forum_table").hide();
		jQuery(".__cpc__subscribe_option").hide();
		jQuery("#new-topic-button").hide();
		jQuery("#forum_breadcrumbs").hide();
		jQuery("#__cpc__forum_dropdown").hide();
		// BB Toolbar
		__cpc__evoke_bbcode_toolbar();
	});
	jQuery("#cancel_post").live("click", function() {
		...
		jQuery(".__cpc__forum_table").show();
		jQuery(".__cpc__subscribe_option").show();
		jQuery("#new-topic-button").show();
		jQuery("#forum_breadcrumbs").show();
		jQuery("#__cpc__forum_dropdown").show();
	});
	...
	jQuery("#cpcommunitie_new_post").live("click", function() {
		...
		if (subject == '') {
			...
			if (text == '') {
				...
				// Check for unclosed BB Codes
				var bbcodes_ok = __cpc__bbcodes_ok(text);
				if (!bbcodes_ok) {
					alert(__cpc__.bbcode_problem);
				} else {
	...
	jQuery("input[type='checkbox']").live("click", function() {
		...
		if (checkbox == "cpcommunitie_for_info") {
			var value = '';
			if (jQuery(this).is(":checked")) {
				value = 'on';
				jQuery(".forum_post_answer").hide();
		...
		if (checkbox == "cpcommunitie_subscribe") {
			jQuery(".__cpc__notice").inmiddle().fadeIn();
			if (jQuery(this).is(":checked")) {
		...
		// Digest
		if (checkbox == "cpcommunitie_digest") {
			jQuery(".__cpc__notice").inmiddle().fadeIn();
			if (jQuery(this).is(":checked")) {
	...
	jQuery(".forum_post_score_change").live("click", function() {
		...
		if (__cpc__.current_user_id == 0) {
			...
			if (change == 'novote') {
				...
				jQuery("#dialog").html(jQuery("#cpcommunitie_novote").html());
				jQuery("#dialog").dialog({
					title: jQuery('#cpcommunitie_novote_dialog').html(),
					width: 600,
					height: 175,
					modal: true,
					buttons: {
				...
				var vote_off = parseFloat(jQuery('#cpcommunitie_forum_vote_remove').html());
				var new_score = score + change;

				if (vote_off != 0 && vote_off == new_score) {
					jQuery('#reply' + tid).html(jQuery('#cpcommunitie_forum_vote_remove_msg').html())
				}

				jQuery('#forum_score_' + tid).html("<img src='" + __cpc__.images_url + "/busy.gif' />");
...
/*
	...
	*/
	...
	if (jQuery("#__cpc__notification_bar").length) {

		// Quick check on polling frequency
		if (__cpc__.panel_enabled) {
			...
			jQuery('.clear_chatbox').live("click",function(){
				...
				jQuery.ajax({
					type: "POST",
					url: __cpc__.plugin_url+'ajax/chat/clear_chat.php',	
					async: true,					
					data: datastring,
					success: function(i){			
						if (i != '1')
			...
			jQuery('.__cpc__chat_user').on('click',function(){
			...
			jQuery('.chat_message textarea').live("keypress", function (e) {
				...
				if (e.keyCode == 13 && !e.shiftKey) {
					...
					var datastring = 'from_id='+__cpc__.current_user_id+'&to_id='+to_id+'&message='+this_textarea.val();
					
					if (this_textarea.val() != __cpc__.sending+'... '+__cpc__.pleasewait+'  ') {

						if (this_textarea.val() != '') {
					
							// show sending message
							this_textarea.val(__cpc__.sending+'... '+__cpc__.pleasewait+'  ').attr('disabled', 'disabled');
		
							jQuery.ajax({
								type: "POST",
								url: __cpc__.plugin_url+'ajax/chat/send_message.php',	
								async: true,					
								data: datastring,
								success: function(i){			
									if(i == 1){
			...
			function liveChat(__cpc__first_load){
				...
				jQuery('.chatbox').each(function(){												
					...
					jQuery.ajax({
						type: "POST",
						url: __cpc__.plugin_url+'ajax/chat/load_message.php',								
						data: 'own_id='+__cpc__.current_user_id+'&partner_id='+this_chatbox_id+'&typing='+is_typing,
						async: true,					
						success: function(i){	
							...
							if(i != 0){			
								...
								if (old_id) {
									...
									if (old_id != new_id){
										...
										if (last_id != __cpc__.current_user_id) {
											...
											if (this_chatbox.data('havenewmessage') == 1) { // blinking chat window if not focused and have a new message
												if (__cpc__.chat_sound != 'none' && this_chatbox.data('playedsound') == 0) { // sound
													this_chatbox.data('playedsound', 1);
													jQuery("#player_div").empty();
													jQuery("#player_div").prepend(__cpc__insertPlayer(__cpc__.plugin_url+'ajax/chat/flash/player.swf', __cpc__.plugin_url+'/ajax/chat/flash/'+__cpc__.chat_sound));
												}
											}	
				...
				jQuery.ajax({
					type: "POST",
					url: __cpc__.plugin_url+'ajax/chat/load_popup_message.php',	
					async: true,					
					data: 'own_id='+__cpc__.current_user_id,
					success: function(o){	
						if(o != 0){
							...
							if(jQuery('div[title="'+substr[0]+'"]').length == 0){					
								PopupChat(substr[0],substr[1],1,__cpc__first_load);
							}												
				...
				t=setTimeout(function() {
				    liveChat(__cpc__first_load);
				}, heartBeat);
			}
			
			var __cpc__first_load = 1;					
			liveChat(__cpc__first_load);	//start the chat
			
			// Set up icon actions ******************************************************
			
			// Hover/click on logout?
			jQuery("#__cpc__logout").mouseenter(function() {
				jQuery("#__cpc__logout_div").show();
			});
			jQuery("#__cpc__logout_div").mouseleave(function() {
				jQuery("#__cpc__logout_div").fadeOut('slow');
			});
			...
			jQuery("#__cpc__logout-link").on('click', function() {
				if (confirm(areyousure)) {
					jQuery.ajax({
						...
						type: "POST",
						data: ({
							action: 'cpcommunitie_logout'
						}),
						dataType: "html",
						async: false,
						success: function(str) {
							window.location.href = __cpc__.site_url;
						}
					});
				} else {
					jQuery("#__cpc__logout_div").hide();
				}
			});
	...
	function do_online_friends_check() {
		...
		if (jQuery("#__cpc__friends_box").css("display") != "none") {
			...
			jQuery.ajax({
				...
				type: "POST",
				data: ({
					action: "cpcommunitie_friendrequests"
				}),
				dataType: "html",
				async: true,
				success: function(str) {
					if (str > 0) {
						jQuery("#__cpc__friends_box").html(str);
						jQuery("#__cpc__friends_box").removeClass("__cpc__friends_box-none");
						jQuery("#__cpc__friends_box").addClass("__cpc__friends_box-new");
					}
				},
				error: function(xhr, ajaxOptions, thrownError) {
					if (show_js_errors) {
			...
			jQuery.ajax({
				...
				type: "POST",
				data: ({
					action: "cpcommunitie_getfriendsonline",
					uid: __cpc__.current_user_id,
					inactive: __cpc__.inactive,
					offline: __cpc__.offline,
					use_chat: __cpc__.use_chat
				}),
				dataType: "html",
				async: true,
				success: function(str) {
					if (str != '') {
						...
						jQuery("#__cpc__online_box").html(split[0]);
						jQuery("#__cpc__friends_online_list").html(split[1]);
						if (split[0] > 0) {
							jQuery("#__cpc__online_box").removeClass("__cpc__online_box-none");
							jQuery("#__cpc__online_box").addClass("__cpc__online_box");
						} else {
							jQuery("#__cpc__online_box").removeClass("__cpc__online_box");
							jQuery("#__cpc__online_box").addClass("__cpc__online_box-none");
						}
					}
				},
				error: function(xhr, ajaxOptions, thrownError) {
	...
	function do_bar_check() {
		...
		var bar_check_cookie = readCookie('cpc_bar_check');
		...
		if (bar_check_cookie == 'lock') {
			...
			createCookie('cpc_bar_check', 'lock', 1);
			...
			if (jQuery("#__cpc__email_box").css("display") != "none") {
				...
				jQuery.ajax({
					...
					type: "POST",
					data: ({
						action: "cpcommunitie_getunreadmail"
					}),
					dataType: "html",
					async: true,
					success: function(str) {
						if (str > 0) {
							jQuery("#__cpc__email_box").html(str);
							jQuery("#__cpc__email_box").removeClass("__cpc__email_box-read");
							jQuery("#__cpc__email_box").addClass("__cpc__email_box-unread");
						}
						eraseCookie('cpc_bar_check');
	...
	function validate_form(thisform) {
		...
		// Registration
		if ((form_id) == "cpcommunitie_registration") {
			var r = true;
			with(thisform) {
	...
	function bar_polling() {
		...
		if (__cpc__.cpc_lite != 'on') {
			setTimeout(bar_polling, __cpc__.bar_polling * 1000);
		}
	}
...
/*
	...
	*/
	...
	if (jQuery("#__cpc__alerts").length && __cpc__.cpc_alerts_activated == 1) {

		// Start regular checks for lounge contents
		if (__cpc__.is_admin == 0) {
			news_polling();
		}
		...
		jQuery('#__cpc__alerts').live("mouseenter", function(event) {
			...
			if (!(jQuery('#__cpc__news_items').is(':visible'))) {
				if (event.type == 'mouseenter') {
					jQuery("#__cpc__news_items").show();

					jQuery.ajax({
						url: __cpc__.plugin_url + "ajax/news_functions.php",
						type: "POST",
						data: ({
	...
	function news_polling() {
			...
			if (!(jQuery('#__cpc__news_items').is(':visible'))) {
				...
				jQuery.ajax({
					...
					success: function(str) {
						...
						jQuery("#__cpc__news_items").remove();
						if (str != '[]') {

							var rows = jQuery.parseJSON(str);

							var items = "<div id='__cpc__news_items' style='display:none;'>";
							...
							jQuery.each(rows, function(i, row) {
								if (row.nid > 0) {
									...
									if (row_count < 10) {
										row_count++;
										items += "<div class='__cpc__news_item'>";
										if (row.new_item == 'on') {
											items += "<span class='__cpc__news_item_newitem'>";
										}
							...
							if (url != '') {
								items += "<div class='__cpc__news_item'>";
								items += '<a id="cpcommunitie_clear_news" style="float:right" href="javascript:void(0)">' + cpcommunitie_clear + '</a>';
							...
							if (new_count > 0) {
								if (jQuery("#__cpc__news_highlight").length > 0) {
									jQuery("#__cpc__news_highlight").html(new_count);
								} else {
									jQuery('<span id="__cpc__news_highlight">' + new_count + '</span>').appendTo('#__cpc__alerts');
								}
							} else {
								jQuery("#__cpc__news_highlight").hide();
							}
							jQuery('body').append(items);
							var __cpc__news_y_offset = parseInt(jQuery("#__cpc__news_y_offset").html());
							var __cpc__news_x_offset = parseInt(jQuery("#__cpc__news_x_offset").html());

							var h = parseInt(jQuery('#__cpc__alerts').parent().css('height').replace(/px/g, ''));
							var o = jQuery('#__cpc__alerts').parent().offset();
							var t = o.top+h;
							var l = o.left;
							jQuery("#__cpc__news_items").css('top', t + __cpc__news_y_offset);
							jQuery("#__cpc__news_items").css('left', l + __cpc__news_x_offset);
		...
		if (__cpc__.cpc_lite != 'on') {
			var polling = jQuery('#__cpc__news_polling').html();
			if (polling < 1) {
				polling = 5;
			}
...
/*
	...
	*/
	...
	if (__cpc__.view == 'cpc_events' && __cpc__.embed == 'on') {

		jQuery('#profile_body').html("<img src='" + __cpc__.images_url + "/busy.gif' />");

		var menu_id = 'menu_events';
		var ajax_path = __cpc__.plugin_url + "ajax/events_functions.php";
	...
	// Calendar view
	if (jQuery("#__cpc__events_calendar").length) {
		var d = new Date();
		jQuery(".__cpc__pleasewait").inmiddle().show();
		jQuery.ajax({
			...
			async: true,
			success: function(str) {
				jQuery("#__cpc__events_calendar").html(str);
				jQuery(".__cpc__pleasewait").hide();
			}
		});		
	}
	...
	jQuery("#cpcommunitie_cancel_event").live("click", function() {
		...
		if (answer) {			
			...
			jQuery('.cpcommunitie_pay_event_button').hide();
			jQuery(".__cpc__pleasewait").inmiddle().show();
			jQuery.ajax({
				url: __cpc__.plugin_url + "ajax/events_functions.php",
				type: "POST",
	...
	jQuery("#cpcommunitie_book_event").live("click", function() {
		...
		var events_howmany = __cpc__.events_howmany;

		jQuery(this).hide();
		var str = events_howmany;
		str += ' <select id="cpcommunitie_events_how_many">';
		for (i = 1; i <= jQuery(this).data('max'); i++) {
			str += '<option value=' + i + '>' + i;
		}
		str += '</select><br /><br />';
		str += '<input id="cpcommunitie_book_event_next" data-eid="' + jQuery(this).data('eid') + '" type="submit" class="__cpc__button" value="' + cpcommunitie_next + ' &gt;" />';
		jQuery("#dialog").html(str).dialog({
			title: __cpc__.site_title,
			width: 400,
			height: 300,
	...
	jQuery("#cpcommunitie_book_event_next").live("click", function() {
		...
		jQuery.ajax({
			...
			data: ({
				...
				'eid': jQuery(this).data('eid'),
				'howmany': jQuery('#cpcommunitie_events_how_many').val()
			}),
			dataType: "html",
			async: true,
			success: function(str) {
	...
	jQuery("#cpcommunitie_add_event_button").live("click", function() {
		...
		if (name == '') {
			...
			// submit to database
			var desc = jQuery("#__cpc__create_event_desc").val().replace(/(<([^>]+)>)/ig, '');
			var location = jQuery("#__cpc__create_event_location").val().replace(/(<([^>]+)>)/ig, '');
				...
				jQuery.ajax({
					...
					success: function(str) {
						if (str == 'OK') {
							jQuery(".__cpc__pleasewait").inmiddle().show();
							var q = cpcommunitie_q(__cpc__.profile_url);
							var reload_page = __cpc__.profile_url + q + "uid=" + __cpc__.current_user_page + "&embed=on&view=cpc_events";
	...
	jQuery(".__cpc__edit_event").live("click", function() {
		...
		var events_enable_places = __cpc__.events_enable_places;
		var events_show_max = __cpc__.events_show_max;
		var events_confirmation = __cpc__.events_confirmation;
		var events_tickets_per_booking = __cpc__.events_tickets_per_booking;
		var events_tab_1 = __cpc__.events_tab_1;
		var events_tab_2 = __cpc__.events_tab_2;
		var events_tab_3 = __cpc__.events_tab_3;
		var events_tab_4 = __cpc__.events_tab_4;
		var events_send_email = __cpc__.events_send_email;
		var events_pay_link = __cpc__.events_pay_link;
		var events_cost = __cpc__.events_cost;
		var events_replacements = __cpc__.events_replacements;
		var events_labels = __cpc__.events_labels.split('|');
		...
		jQuery.ajax({
			...
			success: function(str) {
				...
				var rows = jQuery.parseJSON(str);
				var html = '<div id="__cpc__edit_event_eid" style="display:none;">' + event_id + '</div>';
				...
				jQuery.each(rows, function(i, row) {
					...
					html += '</li>';
					if (__cpc__.events_user_places || __cpc__.current_user_level == 5) {
						html += '<li>';
					...
					html += '<div id="__cpc__edit_event">';

					if (__cpc__.events_user_places || __cpc__.current_user_level == 5) {
						html += "<div style='width:48%; float:right; text-align:left;'>";
						html += "<div style='clear:both'>" + events_enable_places + " <input type='checkbox' style='float:right' id='__cpc__edit_event_enable_places'";
						if (row.enable_places) {
							html += ' CHECKED';
						}
						html += "></div>";
						html += "<div style='clear:both;'>" + events_show_max + " <input type='checkbox' style='float:right' id='__cpc__edit_event_show_max'";
						if (row.show_max) {
							html += ' CHECKED';
						}
						html += "></div>";
						html += "<div style='clear:both;'>" + events_confirmation + " <input type='checkbox' style='float:right' id='__cpc__edit_event_confirmation'";
						if (row.confirmation) {
							html += ' CHECKED';
						}
						html += "></div>";
						html += "<div style='clear:both;'>" + events_send_email + " <input type='checkbox' style='float:right' id='__cpc__edit_event_send_email'";
						if (row.send_email) {
							html += ' CHECKED';
						}
						html += "></div>";
						html += "<div style='clear:both;'>" + events_max_places + " <input type='text' id='__cpc__edit_event_max_places' style='float:right; width:30px' value='" + row.max_places + "'></div>";
						html += "<div style='clear:both;'>" + events_tickets_per_booking + " <input type='text' id='__cpc__edit_event_tickets_per_booking' style='float:right; width:30px' value='" + row.tickets_per_booking + "'></div>";
						html += "<div style='clear:both;'>" + events_cost + " <input type='text' id='__cpc__edit_event_cost' style='float:right; width:30px' value='" + row.cost + "'></div>";
						html += "<div style='clear:both; '>" + events_pay_link + " <a href='javascript:void()' id='cpcommunitie_event_help'><img src='" + __cpc__.images_url + "/info.png' /></a><a style='display:none' href='javascript:void()' id='cpcommunitie_event_help_close'><img src='" + __cpc__.images_url + "/edit.png' /></a><br />";
						...
						html += '##unitcost##';
						html += '</div>';
						html += "<textarea id='__cpc__edit_event_pay_link' style='font-size:11px;font-family:courier new;letter-spacing:-1px;width:370px; height:102px;'>" + row.pay_link + "</textarea>";
						html += "</div>";
						html += '</div>';
					}
					...
					html += "<input type='text' id='__cpc__edit_event_name' class='__cpc__edit_event_input' value='" + row.event_name.replace(/'/g, '&apos;') + "'><br />";
					html += "<input type='text' id='__cpc__edit_event_location' class='__cpc__edit_event_input' value='" + row.event_location.replace(/'/g, '&apos;') + "'><br />";
					html += "<textarea type='text' id='__cpc__edit_event_desc' class='__cpc__edit_event_textarea'>" + row.event_description.replace(/'/g, '&apos;') + "</textarea><br /><br />";

					html += '</div>';

					html += '<div style="margin-top:-13px; text-align:left;width:700px;">';
					html += '<input type="text" id="__cpc__edit_event_start" style="width:100px" class="datepicker" value="';
					if (row.start_date != '01/01/1970' && row.start_date != '11/30/-0001') {
						html += row.start_date
					};
					html += '" /> ';
					html += '<select id="__cpc__edit_event_start_time_hours">';
					...
					html += '</select> : ';
					html += '<select id="__cpc__edit_event_start_time_minutes">';
					html += '<option value=99>-</option>';
					for (i = 0; i <= 3; i++) {
					...
					html += '</select>';
					html += ' &rarr; ';
					html += '<input type="text" id="__cpc__edit_event_end" style="width:100px" class="datepicker" value="';
					if (row.end_date != '01/01/1970' && row.end_date != '11/30/-0001') {
						html += row.end_date
					};
					html += '" /> ';
					html += '<select id="__cpc__edit_event_end_time_hours">';
					html += '<option value=99>-</option>';
					for (i = 0; i <= 23; i++) {
						html += '<option value=' + i;
						if (i == row.end_hours) {
					...
					html += '</select> : ';
					html += '<select id="__cpc__edit_event_end_time_minutes">';
					html += '<option value=99>-</option>';
					for (i = 0; i <= 3; i++) {
						html += '<option value=' + (i * 15);
					...
					html += '<input id="cpcommunitie_event_update_status" type="checkbox" ';
					...
					if (__cpc__.events_user_places || __cpc__.current_user_level == 5) {
						...
						jQuery.each(attendees, function(i, attendee) {
							...
							var q = cpcommunitie_q(__cpc__.profile_url);
							var url = __cpc__.profile_url + q + "uid=" + attendee.uid;
							...
							html += '<td>';
							html += '<a href="mailto:' + attendee.email + '"><img src="' + __cpc__.images_url + '/orange-tick.gif" /></a>&nbsp;&nbsp;';
							html += '<img id="cpcommunitie_events_resend_email" data-bid="' + attendee.bid + '" style="cursor:pointer" src="' + __cpc__.images_url + '/update.png" />&nbsp;&nbsp;';
							html += '<img id="cpcommunitie_events_remove_attendee" data-bid="' + attendee.bid + '" style="cursor:pointer" src="' + __cpc__.images_url + '/delete.png" />&nbsp;&nbsp;';
							if (!attendee.payment_processed) {
								html += '<img id="cpcommunitie_events_payment_processed" data-bid="' + attendee.bid + '" style="cursor:pointer" src="' + __cpc__.images_url + '/cash.png" />&nbsp;&nbsp;';
							}
							if (!attendee.confirmed) {
								html += '<img id="cpcommunitie_events_confirm_attendee" data-bid="' + attendee.bid + '" style="cursor:pointer; width:15px;height:15px" src="' + __cpc__.images_url + '/tick.png" />&nbsp;&nbsp;';
							}
							html += '</td>';
							html += '</tr>';
						...
						var g = '&nbsp;&nbsp;&nbsp;';
						html += '<img src="' + __cpc__.images_url + '/orange-tick.gif" /> ' + events_labels[8] + g;
						html += '<img src="' + __cpc__.images_url + '/update.png" /> ' + events_labels[9] + g;
						html += '<img src="' + __cpc__.images_url + '/delete.png" /> ' + events_labels[10] + g;
						html += '<img src="' + __cpc__.images_url + '/cash.png" /> ' + events_labels[11] + g;
						html += '<img style="width:15px;height:15px" src="' + __cpc__.images_url + '/tick.png" /> ' + events_labels[7] + g;
						html += '</td></tr>';
						html += '</table>';
						html += '</div>';
					...
					html += '<input type="submit" class="cpcommunitie_event_update_button __cpc__button" value="' + cpcommunitie_update + '" />';
					html += '<div style="float: right;" id="cpcommunitie_edit_wait"></div>';
					html += '</div>';
				...
				jQuery("#dialog").dialog({
					title: __cpc__.site_title + ' Event ID:' + event_id,
					width: 850,
					height: 550,
					modal: true,
					buttons: {},
					close: function(ev, ui) {
						jQuery(".__cpc__pleasewait").inmiddle().show();
						var q = cpcommunitie_q(__cpc__.profile_url);
						var reload = __cpc__.profile_url + q + "uid=" + event_owner + "&embed=on&view=cpc_events";
	...
	jQuery(".cpcommunitie_event_update_button").live("click", function() {
		...
		if (__cpc__.events_user_places || __cpc__.current_user_level == 5) {
			...
			var max_places = jQuery('#__cpc__edit_event_max_places').val();
			var cost = jQuery('#__cpc__edit_event_cost').val();
			var pay_link = jQuery('#__cpc__edit_event_pay_link').val();
			var tickets_per_booking = jQuery('#__cpc__edit_event_tickets_per_booking').val();
			var enable_places = '';
			if (jQuery('#__cpc__edit_event_enable_places:checked').val() == 'on') {
				enable_places = 'on';
			}
			var show_max = '';
			if (jQuery('#__cpc__edit_event_show_max:checked').val() == 'on') {
				show_max = 'on';
			}
			var confirmation = '';
			if (jQuery('#__cpc__edit_event_confirmation:checked').val() == 'on') {
				confirmation = 'on';
			}
			var send_email = '';
			if (jQuery('#__cpc__edit_event_send_email:checked').val() == 'on') {
				send_email = 'on';
			}
		} else {
			var max_places = 0;
		...
		var eid = jQuery('#__cpc__edit_event_eid').html();
		var name = jQuery('#__cpc__edit_event_name').val();
		var location = jQuery('#__cpc__edit_event_location').val();
		var google_map = jQuery('#__cpc__edit_event_location').val();
		var desc = jQuery('#__cpc__edit_event_desc').val();
		var start = jQuery('#__cpc__edit_event_start').val();
		var start_hours = jQuery('#__cpc__edit_event_start_time_hours').find(':selected').val();
		var start_minutes = jQuery('#__cpc__edit_event_start_time_minutes').find(':selected').val();
		var end = jQuery('#__cpc__edit_event_end').val();
		var end_hours = jQuery('#__cpc__edit_event_end_time_hours').find(':selected').val();
		var end_minutes = jQuery('#__cpc__edit_event_end_time_minutes').find(':selected').val();
		var event_live = '';
		if (jQuery('#cpcommunitie_event_update_status:checked').val() == 'on') {
			event_live = 'on';
		}
...
/*
	...
	*/
	...
	if (jQuery("input#gallery_member").length) {
		jQuery("input#gallery_member").autocomplete({
			source: __cpc__.plugin_url + "ajax/gallery_functions.php",
			minLength: 3,
			focus: function(event, ui) {
	...
	if (__cpc__.album_id > 0 && __cpc__.embed == 'on') {
	...
	function cpcommunitie_do_gallery_search() {

		var page_length = jQuery('#cpcommunitie_gallery_page_length').html();
		var start = jQuery("#cpcommunitie_gallery_start").html();

		if (start == 0) {
			jQuery('#cpcommunitie_gallery_albums').html("<br /><img src='" + __cpc__.images_url + "/busy.gif' />");
		}
		...
		jQuery.ajax({
			...
			success: function(str) {
				...
				jQuery("#cpcommunitie_gallery_start").html(new_start);
				if (start == 0) {
					jQuery('#cpcommunitie_gallery_albums').html(str);
				} else {
					jQuery('#cpcommunitie_gallery_albums').html(jQuery('#cpcommunitie_gallery_albums').html() + str);
	...
	function prepare_colorbox(t) {
		...
		var div_title = "#cpc_gallery_album_name_" + rel.replace('cpcommunitie_gallery_photos_', '');
		var album_title = '';
		...
		// Build HTML			
		var html = '';
		html += '<div id="__cpc__photo_gallery"';
		if (max_images == 0) html += ' style="height:440px"';		
		html += '>';

		// Info
		html += '<input id="cpcommunitie_current_image" style="display:none" value="' + current_image + '" />';
		html += '<input id="cpcommunitie_max_images" style="display:none" value="' + max_images + '" />';
		html += '<input id="__cpc__album_title" style="display:none" value="' + album_title + '" />';

		if (ids[0] != 0) {
			html += '<div id="__cpc__photo_comments">';

			// Management
			if ((owner == __cpc__.current_user_id || __cpc__.current_user_level == 5) && album_title != '') {
				html += '<div id="__cpc__photo_management" style="margin-bottom:10px">';
				var gallery_labels = __cpc__.gallery_labels.split('|');

				html += '<div id="__cpc__rename_photo" style="margin-bottom:5px"><input type="text" id="__cpc__rename" value="" /><input type="submit" id="__cpc__rename_button" class="__cpc__button" value="' + gallery_labels[0] + '" /></div>';
				html += '<div id="__cpc__rename_photo_confirm" style="margin-bottom:11px;display:none;">' + gallery_labels[1] + '</div>';
				html += '<div id="__cpc__photo_order" style="clear:both">' + gallery_labels[2] + ' <a id="__cpc__photo_order_save" style="text-decoration:underline" href="javascript:void(0);">' + gallery_labels[3] + '</a>.' + '</div>';
				html += '<div class="__cpc__photo_delete" style="cursor:pointer; text-decoration:underline;">' + gallery_labels[4] + '</div>';
				html += '<div class="__cpc__photo_select_cover_button" style="cursor:pointer; text-decoration:underline;">' + gallery_labels[5] + '</div>';
				html += '</div>';
			}

			// Actions
			if (__cpc__.current_user_id > 0 && album_title != '') {
				html += '<div id="__cpc__photo_actions">';
			...
			// Comments
			if (__cpc__.current_user_id > 0 && album_title != '') {
				html += '<div id="__cpc__add_a_comment_label">'+add_a_comment+'</div>';
				html += '<textarea id="__cpc__photo_add_comment" class="elastic"></textarea>';
				html += '<textarea id="__cpc__photo_add_comment_old" style="display:none"></textarea>';
					
				html += '<input id="__cpc__photo_submit_comment" type="button" class="__cpc__button" value="' + btn_add + '" />';
				html += '<input id="__cpc__photo_submit_comment_cancel" type="button" class="__cpc__button" style="display:none" value="' + jQuery('#__cpc__cancel').html() + '" />';
			}
			if (album_title != '') {
				html += '<div id="__cpc__photo_comments_container"></div>';
			}

			html += '</div>';
		}

		html += '<div id="__cpc__photo_container">';

		// Photo frame
		html += '<div id="__cpc__photo_frame">';
		html += '</div>';

		// Thumbnails
		html += '<div id="__cpc__photo_thumbnails"';
		if (max_images == 0) {
		...
		for (var i = 0; i < list.length; i++) {
			...
			var name = names[i];
			html += '<img id="thumb_' + i + '" title="' + name + '" rel="' + ids[i] + '" class="__cpc__photo_thumbnail __cpc__photo_thumbnail_border_off " src="' + url + '" />';
		}
		html += '</div>';
		...
		// Sortable thumbnails
		if (owner == __cpc__.current_user_id && album_title != '') {
			jQuery('#__cpc__photo_thumbnails').sortable();
			jQuery('#__cpc__photo_order_save').on('click', function() {
				var order = '';
				jQuery('#__cpc__photo_thumbnails').children(jQuery('.__cpc__photo_thumbnails')).each(function(i) {
					order += jQuery(this).attr('rel') + ',';
				});

				jQuery("#__cpc__photo_order").html("<img src='" + __cpc__.images_url + "/busy.gif' />");
				jQuery.ajax({
					url: __cpc__.plugin_url + "ajax/gallery_functions.php",
					type: "POST",
					data: ({
						action: 'cpcommunitie_reorder_photos',
						album_id: rel,
						order: order
					}),
					async: false,
					...
					success: function(str) {
						if (str != 'OK') {
							jQuery("#__cpc__photo_order").html(str).effect("highlight", {}, 3000);
						}
					}
				});
			});
		...
		if (__cpc__.use_elastic == 'on' && jQuery(".elastic").length) {
			jQuery('.elastic').elastic();
		}
	...
	jQuery("#__cpc__photo_submit_comment").live("click", function() {
		...
		if (comment != '') {
		  ...
		  var current = parseInt(jQuery("#cpcommunitie_current_image").val());
			var id = jQuery("#thumb_" + current).attr("rel");
			jQuery('#__cpc__photo_comments_container').html("<img src='" + __cpc__.images_url + "/busy.gif' />");

			if (this.value != jQuery('#__cpc__update').html()) {
				// Add
			  jQuery.ajax({
				  url: __cpc__.plugin_url + "ajax/gallery_functions.php",
				  type: "POST",
				  data: ({
			  		action: 'cpcommunitie_add_photo_comment',
			  		photo_id: id,
				  	comment: comment
				  }),
				  async: false,
				  dataType: "html",
				  success: function(str) {
					  cpcommunitie_show_photo_comments(jQuery("#thumb_" + current));
				  }
			  });

		  } else {
			// Update
		    jQuery('#__cpc__photo_submit_comment_cancel').hide();
		    ...
		    jQuery('#__cpc__photo_add_comment').val('');
				...
				jQuery.ajax({
				  ...
				  type: "POST",
				  data: ({
			  		action: 'cpcommunitie_update_photo_comment',
			  		photo_id: id,
				  	comment: comment,
					  old_comment: jQuery('#__cpc__photo_add_comment_old').val()
				  }),
				  async: false,
				  dataType: "html",
				  success: function(str) {
						jQuery("#__cpc__add_a_comment_label").show();
					  cpcommunitie_show_photo_comments(jQuery("#thumb_" + current));
				  }
			  });
			}
	...
	jQuery(".__cpc__photo_thumbnail").on('click', function() {
		var current = jQuery(this).attr("id").replace('thumb_', '');
		jQuery("#cpcommunitie_current_image").val(current);
		display_gallery_item(jQuery("#thumb_" + current));
	})

	jQuery(".__cpc__photo").on('click', function() {
		var current = parseInt(jQuery("#cpcommunitie_current_image").val());
		var max = parseInt(jQuery("#cpcommunitie_max_images").val());
		if (current < max) {
			current++;
		} else {
			current = 0;
	...
	jQuery("body").keydown(function(e) {
		...
		if (!jQuery('#__cpc__photo_add_comment').is(':focus')) {

			if ((e.keyCode == 39 || e.keyCode == 13) && jQuery("#__cpc__photo_gallery").length) {
				var current = parseInt(jQuery("#cpcommunitie_current_image").val());
				var max = parseInt(jQuery("#cpcommunitie_max_images").val());
				if (current < max) {
					current++;
			...
			if (e.keyCode == 37 && jQuery("#__cpc__photo_gallery").length) {
				var current = parseInt(jQuery("#cpcommunitie_current_image").val());
				var max = parseInt(jQuery("#cpcommunitie_max_images").val());
				if (current > 0) {
					current--;
	...
	function display_gallery_item(t) {
		...
		// Show waiting...
		var middle_of_photo_frame_height = (jQuery("#__cpc__photo_frame").height() / 2);
		jQuery("#__cpc__photo_frame").html("<img style='margin-top:" + middle_of_photo_frame_height + "px' src='" + __cpc__.images_url + "/busy.gif' />");
		...
		if (w > 0) {
			cpcommunitie_show_image(t, url, w, h);
		} else {
			setTimeout(function() {
				var w = img.width;
				var h = img.height;
	...
	function cpcommunitie_show_image(t, url, w, h) {

		var photo_frame_width = jQuery("#__cpc__photo_frame").width();
		var photo_frame_height = jQuery("#__cpc__photo_frame").height();
		...
		var show_image = '<img class="__cpc__photo" width=0 height=0 style="margin-top:' + photo_margin_top + 'px; width:' + w + 'px; height:' + h + 'px;" src="' + url + '" />';

		jQuery("#cpcommunitie_current_image").val(jQuery(t).attr("id").replace('thumb_', ''));
		jQuery("#__cpc__photo_frame").html(show_image);

		jQuery(".__cpc__photo_thumbnail").addClass("__cpc__photo_thumbnail_border_off").removeClass("__cpc__photo_thumbnail_border_on");
		jQuery(t).toggleClass("__cpc__photo_thumbnail_border_off").toggleClass("__cpc__photo_thumbnail_border_on");

		// Photo title
		var album_title = jQuery('#__cpc__album_title').val();
		...
		var current_image = jQuery("#cpcommunitie_current_image").val();
		var current_name = jQuery('#thumb_' + current_image).attr('title');
		current_name = current_name.replace(/(<([^>]+)>)/ig, '');
		jQuery('#__cpc__rename').val(current_name);

		// Actions
		jQuery("#show_original").attr("href", url.replace('show_', ''));

		cpcommunitie_show_photo_comments(t);
		jQuery('.__cpc__photo_delete').show();
		jQuery('.__cpc__photo_select_cover_button').show();
		jQuery('#__cpc__rename_photo').show();
		jQuery('#__cpc__rename_photo_confirm').hide();


	}

	function cpcommunitie_show_photo_comments(t) {
		// Comments
		jQuery('#__cpc__photo_comments_container').html("<img src='" + __cpc__.images_url + "/busy.gif' />");
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/gallery_functions.php",
			type: "POST",
			data: ({
				action: 'cpcommunitie_get_photo_comments',
				photo_id: t.attr("rel")
			}),
			dataType: "html",
			success: function(str) {
				if (str != '[]') {
					...
					var rows = jQuery.parseJSON(str);
					jQuery.each(rows, function(i, row) {
						html += '<div class="__cpc__photo_comment hover_row">';
						html += '<div class="__cpc__photo_comment_avatar">';
						html += row.avatar;
						html += '</div>';
						html += '<div>';
						if (row.author_id == __cpc__.current_user_id || __cpc__.current_user_level == 5) {
							html += '<div class="hover_child" style="width:50px;float:right;display:none;">';
							var edit_icon = "<a title='Edit' id='" + row.ID + "' href='javascript:void(0);' class='__cpc__photo_comment_edit_icon'><img src='" + __cpc__.images_url + "/edit.png' style='width:16px;height:16px;' /></a>";
							var del_icon = "<a title='Delete' id='" + row.ID + "' href='javascript:void(0);' class='__cpc__photo_comment_del_icon'><img src='" + __cpc__.images_url + "/delete.png' style='width:16px;height:16px;margin-left:6px;' /></a>";
							html += edit_icon;
							html += del_icon;
							html += '</div>';
						}
				...
				jQuery('#__cpc__photo_comments_container').html(html);
  ...
  jQuery(".__cpc__photo_comment_edit_icon").live("click", function() {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: ({
				action: '__cpc__get_gallery_comment',
				cid: id
			}),
			dataType: "html",
			async: false,
			success: function(str) {
				jQuery(".__cpc__pleasewait").hide();
				str = trim(str);
				jQuery('#__cpc__photo_add_comment').val(str);
				jQuery('#__cpc__photo_add_comment_old').val(str);
				jQuery('#__cpc__photo_add_comment').effect("highlight", {}, 3000);;
			}
		});
	});
  ...
  jQuery(".__cpc__photo_comment_del_icon").live("click", function() {
		...
		jQuery.ajax({
			...
			type: "POST",
			data: ({
				action: '__cpc__delete_gallery_comment',
				cid: id
			}),
			dataType: "html",
			success: function(str) {
	...
	jQuery(".__cpc__photo_select_cover_button").live("click", function() {
		...
		jQuery('#__cpc__photo_thumbnails').children(jQuery('.__cpc__photo_thumbnails')).each(function(i) {
			if (cnt == current) {
				...
				jQuery(t).html("<img src='" + __cpc__.images_url + "/busy.gif' />");
	...
	jQuery("#gallery_share").live("change", function() {
		...
		jQuery.ajax({
			...
			dataType: "html",
			success: function(str) {
				jQuery('#__cpc__album_sharing_save').hide();
				if (str != 'OK') {
					jQuery("#dialog").html(str).dialog({
						title: __cpc__.site_title + ' debug info',
						width: 800,
	...
	jQuery(".__cpc__photo_delete_all").live("click", function() {
		...
		if (confirm("Bist du Dir sicher?")) {
			...
			jQuery.ajax({
				...
				dataType: "html",
				success: function(str) {
					jQuery('.__cpc__photo_row').slideUp("slow");
					var q = cpcommunitie_q(__cpc__.profile_url);
					var reload_page = __cpc__.profile_url + q + "uid=" + __cpc__.current_user_page + "&view=gallery";
					window.location.href = reload_page;
				}
			});
		...
		jQuery('#__cpc__photo_thumbnails').children(jQuery('.__cpc__photo_thumbnails')).each(function(i) {
			if (cnt == current) {
				if (confirm("Bist du Dir sicher?")) {
					...
					var item_id = jQuery(this).attr("rel");
					jQuery(this).remove();
					jQuery("#__cpc__photo_frame").children().fadeOut('slow');
	...
	jQuery("#__cpc__rename_button").live("click", function() {
		...
		jQuery("#__cpc__rename_photo").hide();
		jQuery("#__cpc__rename_photo_confirm").show().effect("highlight", {}, 3000);
	...
	function cpcommunitie_show_album() {
	...
	jQuery(".cpcommunitie_new_album_button").live("click", function() {
		...
		jQuery("#__cpc__create_gallery").show();
		jQuery("#__cpc__album_covers").hide();
		jQuery("#__cpc__album_content").hide();

		if (__cpc__.album_id > 0) {
			jQuery(".__cpc__create_sub_gallery").show();
		} else {
	...
	jQuery("#cpcommunitie_cancel_album").live("click", function() {
		...
		jQuery("#__cpc__album_covers").show();
		jQuery("#__cpc__album_content").show();
		jQuery("#__cpc__create_gallery").hide();
	});
	...
	jQuery("#cpcommunitie_new_album").live("click", function() {
		...
		jQuery.ajax({
			...
			data: ({
				action: 'create_album',
				name: jQuery("#cpcommunitie_new_album_title").val(),
				sub_album: jQuery("#__cpc__create_sub_gallery_select").is(":checked"),
				parent: jQuery("#__cpc__create_sub_gallery_select").attr("title")
			}),
			dataType: "html",
			success: function(str) {
				var q = cpcommunitie_q(__cpc__.profile_url);
				var reload_page = __cpc__.profile_url + q + "uid=" + __cpc__.current_user_page + "&embed=on&album_id=" + str;
				window.location.href = reload_page;
			}
		});
	});
...
/*
	...
	*/
	...
	jQuery(".__cpc__lounge_del_icon").live("click", function() {
		...
		jQuery.ajax({
			url: __cpc__.plugin_url + "ajax/lounge_functions.php",
			type: "POST",
			data: ({
	...
	function add_comment_to_lounge() {
		...
		if (jQuery('#__cpc__lounge_add_comment').val() != 'Einen Kommentar hinzufügen..') {
			...
			items += '<div class="__cpc__lounge_new_status">';
			items += '<img style="float: left" src="' + __cpc__.images_url + '/online.gif">';
			items += '</div>';
			items += '<div class="__cpc__lounge_new_author">';
			items += 'You';
			items += '</div>';
			jQuery(items).prependTo('#__cpc__lounge_div');
			jQuery('#__cpc__lounge_add_comment').val('');
		}
	...
	function lounge_polling() {
		...
		if (jQuery("#__cpc__lounge_div").length) {
			...
			jQuery.ajax({
				...
				success: function(str) {
					...
					jQuery.each(rows, function(i, row) {
						items += '<div id="comment_' + row.lid + '" class="__cpc__lounge_comment">';
						if (__cpc__.current_user_level == 5) {
							var del_icon = "<a title='Delete' id='" + row.lid + "' href='javascript:void(0);' class='__cpc__lounge_del_icon'><img src='" + __cpc__.images_url + "/delete.png' style='width:16px;height:16px' /></a>";
							items += del_icon;
						}

						items += '<div class="__cpc__lounge_new_comment';
						if (row.author_id == __cpc__.current_user_id) {
							items += ' __cpc__lounge_new_comment_you';
						}
						items += '">' + row.comment + '</div>';
						items += '<div class="__cpc__lounge_new_status">';
						items += '<img style="float: left" src="' + __cpc__.images_url + '/' + row.status + '.gif">';
						items += '</div>';
						items += '<div class="__cpc__lounge_new_author">';
					...
					jQuery('#__cpc__lounge_div').html(items);
...
*/
	...
	if (jQuery("#__cpc__chartcontainer").length) {

		var yes = parseFloat(jQuery('#__cpc__chart_yes').html());
		var no = parseFloat(jQuery('#cpcommunitie_chart_no').html());

		if (jQuery("#cpcommunitie_chart_counts").html() != 'on') {
			if (yes > 0) {
				if (no > 0) {
		...
		var bar_type = 'bar';
		if (jQuery("#cpcommunitie_chart_type").html() != '') {
			bar_type = jQuery("#cpcommunitie_chart_type").html();
		}
		var myChart = new JSChart('__cpc__chartcontainer', bar_type, jQuery('#cpcommunitie_chart_key').html());
...
/*
	...
	*/
	...
	// Menu choices
	jQuery(".__cpc__group_menu").on('click', function() {
		...
		jQuery('.__cpc__group_menu').removeClass('__cpc__profile_current');
		jQuery(this).addClass('__cpc__profile_current');
		...
		if (menu_id == 'group_menu_all') {
			window.location.href = __cpc__.groups_url;
		} else {

			jQuery('#group_body').html("<img src='" + __cpc__.images_url + "/busy.gif' />");
			...
			if (menu_id != 'group_menu_forum') {
				...
				jQuery.ajax({
					...
					success: function(str) {
						...
						if (jQuery('#__cpc__group_comment').length) {
							var w = jQuery('#__cpc__group_comment').css('width').replace(/px/g, "");
							jQuery('#__cpc__group_comment').css('width', (w-30)+'px');
						}
						if (jQuery('.__cpc__group_reply').length) {
							var w = jQuery('.__cpc__group_reply').css('width').replace(/px/g, "");
							jQuery('.__cpc__group_reply').css('width', (w-30)+'px');
						}
	...
	jQuery("#__cpc__about_group_edit").live("click", function() {
		...
		jQuery("#dialog").html("<img src='" + __cpc__.images_url + "/busy.gif' />").dialog({
			...
			buttons: {
				"Update": function() {
					jQuery(".__cpc__notice").inmiddle().show();
					var message = tinyMCE.get('__cpc__about_group_edit_textarea').getContent();
					jQuery("#__cpc__group_about_page").html(message);
					jQuery(this).dialog("close");
		...
		jQuery.ajax({
			...
			success: function(str) {
				jQuery("#dialog").html(str);
				tiny_mce_init('__cpc__about_group_edit_textarea');
			}
		});
	...
	if ( (__cpc__.current_group > 0) && ((__cpc__.cat_id != '') && (__cpc__.cat_id)) || ((__cpc__.post != '') && (__cpc__.current_group > 0)) ) {
				...
				if (menu_id == 'group_menu_about') {
					...
					jQuery.ajax({
						...
						success: function(str) {
							...
							// Init TinyMCE
							tiny_mce_init('__cpc__about_group_edit_div');
	...
	function cpcommunitie_add_group_comment() {

		var comment_text = jQuery("#__cpc__group_comment").val();
		jQuery("#__cpc__group_comment").val('');
		...
		jQuery.ajax({
			...
			data: ({
				...
				subject_uid: __cpc__.current_group,
				author_uid: __cpc__.current_user_id,
				parent: 0,
				text: comment_text
			}),
			dataType: "html",
	...
	jQuery(".reply_field-button").live("click", function() {
		...
		cpcommunitie_add_group_reply(this);
	});
	jQuery('.__cpc__group_reply').on('keypress', function(e) {
	...
	function cpcommunitie_add_group_reply(t) {

		var comment_id = jQuery(t).attr("title");
		var author_id = jQuery('#cpcommunitie_author_' + comment_id).val();
		var comment_text = jQuery("#__cpc__reply_" + comment_id).val();
	...
	jQuery("#updateGroupSettingsButton").live("click", function() {
		...
		if (!complete) {
			jQuery("#dialog").html('Please complete group name and description').dialog({ title: __cpc__.site_title, width: 300, height: 200, modal: true, buttons: { "OK": function() { jQuery(this).dialog("close"); } } });
		} else {
...
/*
	...
	*/
	...
	if (jQuery("input#__cpc__group").length) {

		jQuery("input#__cpc__group").autocomplete({
			source: __cpc__.plugin_url + "ajax/groups_functions.php",
			minLength: 3,
			focus: function(event, ui) {
		...
		jQuery.ajax({
			...
			data: ({
				action: "getGroups",
				page: 1,
				me: __cpc__.current_user_id
			}),
			dataType: "html",
			async: true,
			success: function(str) {
				jQuery("#__cpc__groups").html(str);
			},
			error: function(xhr, ajaxOptions, thrownError) {
				if (show_js_errors) {
					alert(xhr.status);
	...
	jQuery("#create_group_button").on('click', function() {
		...
		if (name_of_group != '') {
			...
			jQuery.ajax({
				...
				success: function(str) {
					var q = cpcommunitie_q(__cpc__.group_url);
					window.location.href = __cpc__.group_url + q + 'gid=' + trim(str);
				},
				error: function(xhr, ajaxOptions, thrownError) {
					if (show_js_errors) {
						alert(xhr.status);
	...
	jQuery("#cpcommunitie_group_invites_button").live("click", function() {
		...
		var emails = jQuery('#cpcommunitie_group_invites').val();
		...
		jQuery.ajax({
			...
			success: function(str) {
				jQuery(".__cpc__pleasewait").hide();
				jQuery('#cpcommunitie_group_invites_button').hide();
				jQuery('#cpcommunitie_group_invites').hide();
				jQuery('#cpcommunitie_group_invites_sent').html(str).show();
			},
			error: function(xhr, ajaxOptions, thrownError) {
				if (show_js_errors) {
					alert(xhr.status);
...
// sort out ? or & in CPC link
function cpcommunitie_q(u) {
...
/* FILE UPLOAD */
function __cpc__init_file_upload() {

//	if (jQuery('#__cpc__fileupload').length) {
		
	    // Initialize the jQuery File Upload widget:
	    jQuery('#__cpc__fileupload').fileupload({
	        // Uncomment the following to send cross-domain cookies:
	        //xhrFields: {withCredentials: true},
	        url: __cpc__.plugin_url+'/server/php/',
	        autoUpload: true,
	    ...
	    // Load existing files:
	    jQuery('#__cpc__fileupload').fileupload('option', {
		...
		jQuery('#__cpc__fileupload').bind('fileuploadstop', function (e) {
			if (jQuery('#uploader_ver').val() == 'gallery') {
				jQuery(".__cpc__pleasewait").inmiddle().show();
				var q = cpcommunitie_q(__cpc__.profile_url);
				var href = __cpc__.profile_url + q + 'uid=' + __cpc__.current_user_id + '&view=gallery';
				window.location.href = href;
			}
		});
	
		jQuery('#__cpc__fileupload').bind('fileuploaddone', function (e, data) { 
			...
			jQuery.ajax({
				url: __cpc__.plugin_url + 'server/upload_'+ver+'.php',
				type: "POST",
				data: ({
					action: "after_upload_complete",
					uid: __cpc__.current_user_page,
					user_id: __cpc__.current_user_id,
					user_login: jQuery("#cpcommunitie_user_login").html(),
					user_email: jQuery("#cpcommunitie_user_email").html(),
					uploaded_file: __cpc__.cpc_content_dir+'/members/'+__cpc__.current_user_id+'/'+ver+'_upload/'+data.files[0].name,
...
//	}
	...
	var heartBeat = __cpc__.chat_polling * 1000;	//chat auto refresh time in miliseconds	
	...
	function PopupChat(partner_id,partner_username,chatbox_status,__cpc__first_load){
		windowscount ++;
		chatboxcount ++;
		var wctr = windowscount;
		var q = cpcommunitie_q(__cpc__.profile_url);
		var href = __cpc__.profile_url + q + 'uid=' + partner_id;
		...
		jQuery('body').append('<div class="chatbox cb_default" id="chat_window_'+wctr+'" title="'+partner_id+'">'+
			'<div class="header header_bg_default" title="'+partner_username+'">'+
				...
				'<a href="#" class="close_chatbox" title="close chat window"><img src="'+__cpc__.images_url+'/close.png" alt="Close" /></a>'+
				'<a href="#" class="popup_chatbox" rel="'+partner_id+'" title="'+partner_username+'"><img src="'+__cpc__.images_url+'/popup.gif" alt="Popup" /></a>'+
				'<a href="#" class="clear_chatbox" title="clear chat window"><img src="'+__cpc__.images_url+'/delete.png" alt="Clear" /></a>'+
			...
			'<div class="chat_message" title="Type your message here">'+
				'<div class="chat_user_replying"><img src="'+__cpc__.images_url+'/chat_replying.png" alt="Typing..." /></div>' +
				'<textarea></textarea>'+
			'</div>'+
		'</div>');
		if (chatbox_status == 2) {
		...
		print_to_chat('chat_window_'+wctr,'<p class="system">'+__cpc__.pleasewait+'...</p>');

		if (!__cpc__first_load && __cpc__.chat_sound != 'none') { // sound
			jQuery("#player_div").empty();
			jQuery("#player_div").prepend(__cpc__insertPlayer(__cpc__.plugin_url+'/ajax/chat/flash/player.swf', __cpc__.plugin_url+'/ajax/chat/flash/'+__cpc__.chat_sound));
		} 
	...
	function UpdateChatWindowStatus(){
		...
		jQuery.ajax({
			type: "POST",
			url: __cpc__.plugin_url+'ajax/chat/set_status.php',
			async: false,					
...
function tiny_mce_init(editor_id) {
	...
	if (!__cpc__.use_wp_editor) {
		...
		if (__cpc__.cpc_wysiwyg == 'on' || editor_id == '__cpc__about_group_edit_textarea' || editor_id == 'edit_event_text' || editor_id == 'edit_event_more') {

			var css = __cpc__.cpc_wysiwyg_css;
			if (editor_id == 'edit_topic_text' || editor_id == '__cpc__about_group_edit_textarea') {
				// revert to default to tie in with dialog white background
				css = __cpc__.plugins + "/cp-communitie/tiny_mce/themes/advanced/skins/cpc.css";
			}

			var my_width = __cpc__.cpc_wysiwyg_width;
			var my_height = __cpc__.cpc_wysiwyg_height;
			var toolbar1 = __cpc__.cpc_wysiwyg_1;
			var toolbar2 = __cpc__.cpc_wysiwyg_2;
			var toolbar3 = __cpc__.cpc_wysiwyg_3;
			var toolbar4 = __cpc__.cpc_wysiwyg_4;
			if (editor_id == 'edit_event_text' || editor_id == 'edit_event_more' || editor_id == '__cpc__about_group_edit_textarea') {
				my_width = '565px';
				my_height = '355px';
				...
				if (__cpc__.debug) toolbar1 += ',code';
			...
			if (editor_id == '__cpc__about_group_edit_textarea') {
				my_width = '820px';
				my_height  = '410px';
			}

			if (__cpc__.include_context == 'on') {
...
jQuery.fn.extend({
  ...
  if (myValueStart.indexOf("???") > 0) {
  	var url=prompt(__cpc__.bbcode_url,"");
  	if (url==null) { url = ''; }
  ...
  var text = '';
  if (myValueStart.indexOf("!!!") > 0) {
  	var text=prompt(__cpc__.bbcode_label,"");
  	if (text==null) { text = ''; }
  }
...
function __cpc__bbcodes_ok(reply_text) {
