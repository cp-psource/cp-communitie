	...
	*/
	...
	if (jQuery("#__cpc__notification_bar").length) {
		...
		if (__cpc__.panel_enabled) {
			...
			jQuery('.__cpc__chat_user').live('click',function(){
	...
	*/
	...
	function prepare_colorbox(t) {
		...
		if (owner == __cpc__.current_user_id && album_title != '') {
			...
			jQuery('#__cpc__photo_order_save').live('click', function() {
				var order = '';
	...
	jQuery(".__cpc__photo_thumbnail").live('click', function() {
	...
	jQuery(".__cpc__photo").live('click', function() {
		var current = parseInt(jQuery("#cpcommunitie_current_image").val());
...
/*
	...
	*/
	...
	// Menu choices
	jQuery(".__cpc__group_menu").live('click', function() {
	...
	jQuery('.__cpc__group_reply').live('keypress', function(e) {
