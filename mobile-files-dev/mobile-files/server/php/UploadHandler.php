...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
		...
		if (isset($_POST['uploader_uid'])) {			
			$uid = $_POST['uploader_uid'];
            
            if ($uid && $uid > 0) {
        
                $this->options = array(
                    'script_url' => $this->get_full_url().'/',
                    'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/../../../wp-content/cpc-content/members/'.$uid.'/m_upload/',
                    'upload_url' => $this->get_full_url().'/../../../wp-content/cpc-content/members/'.$uid.'/m_upload/',
                    'user_dirs' => false,
                    'mkdir_mode' => 0755,
                    'param_name' => 'files',
