		...
		if (isset($_POST['uploader_uid'])) {			
            ...
            if ($uid && $uid > 0) {
                ...
                $this->options = array(
                    ...
                    'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/../../../wp-content/wps-content/members/'.$uid.'/m_upload/',
                    'upload_url' => $this->get_full_url().'/../../../wp-content/wps-content/members/'.$uid.'/m_upload/',
                    'user_dirs' => false,
                    'mkdir_mode' => 0755,
                    'param_name' => 'files',
