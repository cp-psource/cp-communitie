...
<div id="primary">
	...
	echo '<div id="my-content" class="__cpc__wrapper">';	
		if ($cpc_user->is_permitted()) { 
			...
			echo '<div id="my-menu">';
				if ($cpc_user->get_id() == $current_user->ID) {
					echo '<div id="menu_wall" class="__cpc__profile_menu">My Activity</div>';
				} else {
					echo '<div id="menu_wall" class="__cpc__profile_menu">Activity</div>';
				}
				echo '<div id="menu_activity" class="__cpc__profile_menu">Friends Activity</div>';
				echo '<div id="menu_all" class="__cpc__profile_menu">All Activity</div>';
